...
class SearchResultsResponseDataObject(BaseModel):
    """
    SearchResultsResponseDataObject
    """
    data: Optional[conlist(SearchResultValueObjectObject)] = None
    search_settings: Optional[SearchSettingsValueObject] = Field(None, alias="searchSettings")
    __properties = ["data", "searchSettings"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SearchResultsResponseDataObject:
        """Create an instance of SearchResultsResponseDataObject from a JSON string"""
    ...
    def to_dict(self):
        ...
        if self.data:
            ...
            _dict['data'] = _items
        # override the default output from pydantic by calling `to_dict()` of search_settings
        if self.search_settings:
            _dict['searchSettings'] = self.search_settings.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> SearchResultsResponseDataObject:
        """Create an instance of SearchResultsResponseDataObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SearchResultsResponseDataObject.parse_obj(obj)

        _obj = SearchResultsResponseDataObject.parse_obj({
            "data": [SearchResultValueObjectObject.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
            "search_settings": SearchSettingsValueObject.from_dict(obj.get("searchSettings")) if obj.get("searchSettings") is not None else None
        })
        return _obj
