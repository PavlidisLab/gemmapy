...
class FactorValueBasicValueObject(BaseModel):
    """
    FactorValueBasicValueObject
    """
    id: Optional[StrictInt] = None
    experimental_factor_id: Optional[StrictInt] = Field(None, alias="experimentalFactorId")
    experimental_factor_category: Optional[CharacteristicBasicValueObject] = Field(None, alias="experimentalFactorCategory")
    measurement: Optional[MeasurementValueObject] = None
    characteristics: Optional[conlist(CharacteristicBasicValueObject)] = None
    value: Optional[StrictStr] = None
    summary: Optional[StrictStr] = None
    __properties = ["id", "experimentalFactorId", "experimentalFactorCategory", "measurement", "characteristics", "value", "summary"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FactorValueBasicValueObject:
        """Create an instance of FactorValueBasicValueObject from a JSON string"""
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic by calling `to_dict()` of experimental_factor_category
        if self.experimental_factor_category:
            _dict['experimentalFactorCategory'] = self.experimental_factor_category.to_dict()
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FactorValueBasicValueObject:
        """Create an instance of FactorValueBasicValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FactorValueBasicValueObject.parse_obj(obj)

        _obj = FactorValueBasicValueObject.parse_obj({
            "id": obj.get("id"),
            "experimental_factor_id": obj.get("experimentalFactorId"),
            "experimental_factor_category": CharacteristicBasicValueObject.from_dict(obj.get("experimentalFactorCategory")) if obj.get("experimentalFactorCategory") is not None else None,
            "measurement": MeasurementValueObject.from_dict(obj.get("measurement")) if obj.get("measurement") is not None else None,
            "characteristics": [CharacteristicBasicValueObject.from_dict(_item) for _item in obj.get("characteristics")] if obj.get("characteristics") is not None else None,
            "value": obj.get("value"),
