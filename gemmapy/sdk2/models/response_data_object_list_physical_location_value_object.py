...
class ResponseDataObjectListPhysicalLocationValueObject(BaseModel):
    """
    ResponseDataObjectListPhysicalLocationValueObject
    """
    data: Optional[conlist(PhysicalLocationValueObject)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResponseDataObjectListPhysicalLocationValueObject:
        """Create an instance of ResponseDataObjectListPhysicalLocationValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResponseDataObjectListPhysicalLocationValueObject:
        """Create an instance of ResponseDataObjectListPhysicalLocationValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResponseDataObjectListPhysicalLocationValueObject.parse_obj(obj)

        _obj = ResponseDataObjectListPhysicalLocationValueObject.parse_obj({
            "data": [PhysicalLocationValueObject.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
