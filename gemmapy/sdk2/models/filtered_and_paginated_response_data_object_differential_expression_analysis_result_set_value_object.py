...
class FilteredAndPaginatedResponseDataObjectDifferentialExpressionAnalysisResultSetValueObject(BaseModel):
    """
    FilteredAndPaginatedResponseDataObjectDifferentialExpressionAnalysisResultSetValueObject
    """
    data: Optional[conlist(DifferentialExpressionAnalysisResultSetValueObject)] = None
    ...
    __properties = ["data", "filter", "groupBy", "sort", "offset", "limit", "totalElements"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FilteredAndPaginatedResponseDataObjectDifferentialExpressionAnalysisResultSetValueObject:
        """Create an instance of FilteredAndPaginatedResponseDataObjectDifferentialExpressionAnalysisResultSetValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FilteredAndPaginatedResponseDataObjectDifferentialExpressionAnalysisResultSetValueObject:
        """Create an instance of FilteredAndPaginatedResponseDataObjectDifferentialExpressionAnalysisResultSetValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FilteredAndPaginatedResponseDataObjectDifferentialExpressionAnalysisResultSetValueObject.parse_obj(obj)

        _obj = FilteredAndPaginatedResponseDataObjectDifferentialExpressionAnalysisResultSetValueObject.parse_obj({
            "data": [DifferentialExpressionAnalysisResultSetValueObject.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
