...
class AnnotationSearchResultValueObject(BaseModel):
    """
    ...
    __properties = ["value", "valueUri", "category", "categoryUri"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AnnotationSearchResultValueObject:
        """Create an instance of AnnotationSearchResultValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AnnotationSearchResultValueObject:
        """Create an instance of AnnotationSearchResultValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AnnotationSearchResultValueObject.parse_obj(obj)

        _obj = AnnotationSearchResultValueObject.parse_obj({
            "value": obj.get("value"),
