...
class SearchResultValueObjectExpressionExperimentValueObject(BaseModel):
    """
    SearchResultValueObjectExpressionExperimentValueObject
    """
    result_id: Optional[StrictInt] = Field(None, alias="resultId")
    result_type: Optional[conlist(StrictStr)] = Field(None, alias="resultType")
    score: Optional[Union[StrictFloat, StrictInt]] = None
    highlights: Optional[Dict[str, StrictStr]] = None
    result_object: Optional[ExpressionExperimentValueObject] = Field(None, alias="resultObject")
    __properties = ["resultId", "resultType", "score", "highlights", "resultObject"]
    ...
    def result_type_validate_enum(cls, value):
        ...
        for i in value:
            if i not in ('ubic.gemma.model.expression.designElement.CompositeSequence', 'ubic.gemma.model.analysis.expression.ExpressionExperimentSet', 'ubic.gemma.model.association.phenotype.PhenotypeAssociation', 'ubic.gemma.model.expression.arrayDesign.ArrayDesign', 'ubic.gemma.model.expression.experiment.ExpressionExperiment', 'ubic.gemma.model.genome.biosequence.BioSequence', 'ubic.gemma.model.common.description.BibliographicReference', 'ubic.gemma.model.genome.Gene', 'ubic.gemma.model.genome.gene.GeneSet', 'ubic.gemma.model.expression.BlacklistedEntity'):
                raise ValueError("each list item must be one of ('ubic.gemma.model.expression.designElement.CompositeSequence', 'ubic.gemma.model.analysis.expression.ExpressionExperimentSet', 'ubic.gemma.model.association.phenotype.PhenotypeAssociation', 'ubic.gemma.model.expression.arrayDesign.ArrayDesign', 'ubic.gemma.model.expression.experiment.ExpressionExperiment', 'ubic.gemma.model.genome.biosequence.BioSequence', 'ubic.gemma.model.common.description.BibliographicReference', 'ubic.gemma.model.genome.Gene', 'ubic.gemma.model.genome.gene.GeneSet', 'ubic.gemma.model.expression.BlacklistedEntity')")
        return value
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SearchResultValueObjectExpressionExperimentValueObject:
        """Create an instance of SearchResultValueObjectExpressionExperimentValueObject from a JSON string"""
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic by calling `to_dict()` of result_object
        if self.result_object:
            _dict['resultObject'] = self.result_object.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> SearchResultValueObjectExpressionExperimentValueObject:
        """Create an instance of SearchResultValueObjectExpressionExperimentValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SearchResultValueObjectExpressionExperimentValueObject.parse_obj(obj)

        _obj = SearchResultValueObjectExpressionExperimentValueObject.parse_obj({
            "result_id": obj.get("resultId"),
            "result_type": obj.get("resultType"),
            "score": obj.get("score"),
            "highlights": obj.get("highlights"),
            "result_object": ExpressionExperimentValueObject.from_dict(obj.get("resultObject")) if obj.get("resultObject") is not None else None
        })
        return _obj
