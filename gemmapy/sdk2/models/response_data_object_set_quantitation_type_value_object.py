...
class ResponseDataObjectSetQuantitationTypeValueObject(BaseModel):
    """
    ResponseDataObjectSetQuantitationTypeValueObject
    """
    data: Optional[conlist(QuantitationTypeValueObject, unique_items=True)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResponseDataObjectSetQuantitationTypeValueObject:
        """Create an instance of ResponseDataObjectSetQuantitationTypeValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResponseDataObjectSetQuantitationTypeValueObject:
        """Create an instance of ResponseDataObjectSetQuantitationTypeValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResponseDataObjectSetQuantitationTypeValueObject.parse_obj(obj)

        _obj = ResponseDataObjectSetQuantitationTypeValueObject.parse_obj({
            "data": [QuantitationTypeValueObject.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
