...
class ResponseDataObjectListArrayDesignValueObject(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResponseDataObjectListArrayDesignValueObject:
        """Create an instance of ResponseDataObjectListArrayDesignValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResponseDataObjectListArrayDesignValueObject:
        """Create an instance of ResponseDataObjectListArrayDesignValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResponseDataObjectListArrayDesignValueObject.parse_obj(obj)

        _obj = ResponseDataObjectListArrayDesignValueObject.parse_obj({
