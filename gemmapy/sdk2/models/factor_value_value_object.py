...
class FactorValueValueObject(BaseModel):
    """
    FactorValueValueObject
    """
    id: Optional[StrictInt] = None
    category: Optional[StrictStr] = None
    category_uri: Optional[StrictStr] = Field(None, alias="categoryUri")
    description: Optional[StrictStr] = None
    factor_value: Optional[StrictStr] = Field(None, alias="factorValue")
    value: Optional[StrictStr] = None
    value_uri: Optional[StrictStr] = Field(None, alias="valueUri")
    char_id: Optional[StrictInt] = Field(None, alias="charId")
    factor_id: Optional[StrictInt] = Field(None, alias="factorId")
    characteristics: Optional[conlist(CharacteristicBasicValueObject)] = None
    measurement: Optional[MeasurementValueObject] = None
    is_measurement: Optional[StrictBool] = Field(None, alias="isMeasurement")
    __properties = ["id", "category", "categoryUri", "description", "factorValue", "value", "valueUri", "charId", "factorId", "characteristics", "measurement", "isMeasurement"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FactorValueValueObject:
        """Create an instance of FactorValueValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FactorValueValueObject:
        """Create an instance of FactorValueValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FactorValueValueObject.parse_obj(obj)

        _obj = FactorValueValueObject.parse_obj({
            "id": obj.get("id"),
            "category": obj.get("category"),
            "category_uri": obj.get("categoryUri"),
            "description": obj.get("description"),
            "factor_value": obj.get("factorValue"),
            "value": obj.get("value"),
            "value_uri": obj.get("valueUri"),
            "char_id": obj.get("charId"),
            ...
            "is_measurement": obj.get("isMeasurement")
        })
        return _obj
