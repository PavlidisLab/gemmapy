...
class CharacteristicBasicValueObject(BaseModel):
    """
    ...
    __properties = ["id", "value", "valueUri", "category", "categoryUri"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CharacteristicBasicValueObject:
        """Create an instance of CharacteristicBasicValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CharacteristicBasicValueObject:
        """Create an instance of CharacteristicBasicValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CharacteristicBasicValueObject.parse_obj(obj)

        _obj = CharacteristicBasicValueObject.parse_obj({
            "id": obj.get("id"),
            "value": obj.get("value"),
