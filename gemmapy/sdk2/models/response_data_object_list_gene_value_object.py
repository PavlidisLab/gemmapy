...
class ResponseDataObjectListGeneValueObject(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResponseDataObjectListGeneValueObject:
        """Create an instance of ResponseDataObjectListGeneValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResponseDataObjectListGeneValueObject:
        """Create an instance of ResponseDataObjectListGeneValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResponseDataObjectListGeneValueObject.parse_obj(obj)

        _obj = ResponseDataObjectListGeneValueObject.parse_obj({
