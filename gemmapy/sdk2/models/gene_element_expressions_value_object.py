...
class GeneElementExpressionsValueObject(BaseModel):
    """
    GeneElementExpressionsValueObject
    """
    gene_official_symbol: Optional[StrictStr] = Field(None, alias="geneOfficialSymbol")
    gene_ncbi_id: Optional[StrictInt] = Field(None, alias="geneNcbiId")
    vectors: Optional[conlist(VectorElementValueObject)] = None
    __properties = ["geneOfficialSymbol", "geneNcbiId", "vectors"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GeneElementExpressionsValueObject:
        """Create an instance of GeneElementExpressionsValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GeneElementExpressionsValueObject:
        """Create an instance of GeneElementExpressionsValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GeneElementExpressionsValueObject.parse_obj(obj)

        _obj = GeneElementExpressionsValueObject.parse_obj({
            "gene_official_symbol": obj.get("geneOfficialSymbol"),
            "gene_ncbi_id": obj.get("geneNcbiId"),
            "vectors": [VectorElementValueObject.from_dict(_item) for _item in obj.get("vectors")] if obj.get("vectors") is not None else None
        })
        return _obj
