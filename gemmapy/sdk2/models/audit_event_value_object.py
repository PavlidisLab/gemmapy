...
class AuditEventValueObject(BaseModel):
    """
    ...
    action_name: Optional[StrictStr] = Field(None, alias="actionName")
    event_type_name: Optional[StrictStr] = Field(None, alias="eventTypeName")
    __properties = ["id", "performer", "date", "action", "note", "detail", "actionName", "eventTypeName"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AuditEventValueObject:
        """Create an instance of AuditEventValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AuditEventValueObject:
        """Create an instance of AuditEventValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AuditEventValueObject.parse_obj(obj)

        _obj = AuditEventValueObject.parse_obj({
            "id": obj.get("id"),
            ...
            "action_name": obj.get("actionName"),
