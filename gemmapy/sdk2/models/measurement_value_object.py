...
class MeasurementValueObject(BaseModel):
    """
    ...
    __properties = ["id", "value", "unit", "type", "representation"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> MeasurementValueObject:
        """Create an instance of MeasurementValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> MeasurementValueObject:
        """Create an instance of MeasurementValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return MeasurementValueObject.parse_obj(obj)

        _obj = MeasurementValueObject.parse_obj({
            "id": obj.get("id"),
            "value": obj.get("value"),
            "unit": obj.get("unit"),
            "type": obj.get("type"),
