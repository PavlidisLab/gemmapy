...
class DatabaseEntryValueObject(BaseModel):
    """
    ...
    __properties = ["id", "accession", "externalDatabase"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DatabaseEntryValueObject:
        """Create an instance of DatabaseEntryValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DatabaseEntryValueObject:
        """Create an instance of DatabaseEntryValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DatabaseEntryValueObject.parse_obj(obj)

        _obj = DatabaseEntryValueObject.parse_obj({
            "id": obj.get("id"),
