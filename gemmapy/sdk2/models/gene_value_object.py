...
class GeneValueObject(BaseModel):
    ...
    aliases: Optional[conlist(StrictStr, unique_items=True)] = None
    multifunctionality_rank: Optional[Union[StrictFloat, StrictInt]] = Field(None, alias="multifunctionalityRank")
    ncbi_id: Optional[StrictInt] = Field(None, alias="ncbiId")
    ensembl_id: Optional[StrictStr] = Field(None, alias="ensemblId")
    accessions: Optional[conlist(DatabaseEntryValueObject, unique_items=True)] = None
    official_name: Optional[StrictStr] = Field(None, alias="officialName")
    official_symbol: Optional[StrictStr] = Field(None, alias="officialSymbol")
    taxon: Optional[TaxonValueObject] = None
    __properties = ["id", "aliases", "multifunctionalityRank", "ncbiId", "ensemblId", "accessions", "officialName", "officialSymbol", "taxon"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GeneValueObject:
        """Create an instance of GeneValueObject from a JSON string"""
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic by calling `to_dict()` of each item in accessions (list)
        _items = []
        if self.accessions:
            for _item in self.accessions:
                if _item:
                    _items.append(_item.to_dict())
            _dict['accessions'] = _items
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GeneValueObject:
        """Create an instance of GeneValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GeneValueObject.parse_obj(obj)

        _obj = GeneValueObject.parse_obj({
            "id": obj.get("id"),
            "aliases": obj.get("aliases"),
            "multifunctionality_rank": obj.get("multifunctionalityRank"),
            "ncbi_id": obj.get("ncbiId"),
            "ensembl_id": obj.get("ensemblId"),
            "accessions": [DatabaseEntryValueObject.from_dict(_item) for _item in obj.get("accessions")] if obj.get("accessions") is not None else None,
            "official_name": obj.get("officialName"),
            "official_symbol": obj.get("officialSymbol"),
