...
class TaxonValueObject(BaseModel):
    """
    TaxonValueObject
    """
    ...
    __properties = ["id", "scientificName", "commonName", "ncbiId", "externalDatabase"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaxonValueObject:
        """Create an instance of TaxonValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> TaxonValueObject:
        """Create an instance of TaxonValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaxonValueObject.parse_obj(obj)

        _obj = TaxonValueObject.parse_obj({
            "id": obj.get("id"),
