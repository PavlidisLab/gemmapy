...
class FilteredAndPaginatedResponseDataObjectGeneValueObject(BaseModel):
    """
    FilteredAndPaginatedResponseDataObjectGeneValueObject
    """
    data: Optional[conlist(GeneValueObject)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FilteredAndPaginatedResponseDataObjectGeneValueObject:
        """Create an instance of FilteredAndPaginatedResponseDataObjectGeneValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FilteredAndPaginatedResponseDataObjectGeneValueObject:
        """Create an instance of FilteredAndPaginatedResponseDataObjectGeneValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FilteredAndPaginatedResponseDataObjectGeneValueObject.parse_obj(obj)

        _obj = FilteredAndPaginatedResponseDataObjectGeneValueObject.parse_obj({
            "data": [GeneValueObject.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
