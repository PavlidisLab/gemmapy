...
class WellComposedErrorBody(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> WellComposedErrorBody:
        """Create an instance of WellComposedErrorBody from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> WellComposedErrorBody:
        """Create an instance of WellComposedErrorBody from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return WellComposedErrorBody.parse_obj(obj)

        _obj = WellComposedErrorBody.parse_obj({
            "code": obj.get("code"),
