...
class PaginatedResponseDataObjectCompositeSequenceValueObject(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedResponseDataObjectCompositeSequenceValueObject:
        """Create an instance of PaginatedResponseDataObjectCompositeSequenceValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedResponseDataObjectCompositeSequenceValueObject:
        """Create an instance of PaginatedResponseDataObjectCompositeSequenceValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginatedResponseDataObjectCompositeSequenceValueObject.parse_obj(obj)

        _obj = PaginatedResponseDataObjectCompositeSequenceValueObject.parse_obj({
