...
class FilteredAndPaginatedResponseDataObjectArrayDesignValueObject(BaseModel):
    """
    FilteredAndPaginatedResponseDataObjectArrayDesignValueObject
    """
    data: Optional[conlist(ArrayDesignValueObject)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FilteredAndPaginatedResponseDataObjectArrayDesignValueObject:
        """Create an instance of FilteredAndPaginatedResponseDataObjectArrayDesignValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FilteredAndPaginatedResponseDataObjectArrayDesignValueObject:
        """Create an instance of FilteredAndPaginatedResponseDataObjectArrayDesignValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FilteredAndPaginatedResponseDataObjectArrayDesignValueObject.parse_obj(obj)

        _obj = FilteredAndPaginatedResponseDataObjectArrayDesignValueObject.parse_obj({
            "data": [ArrayDesignValueObject.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
