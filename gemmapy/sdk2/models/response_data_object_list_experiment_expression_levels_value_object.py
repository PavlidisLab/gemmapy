...
class ResponseDataObjectListExperimentExpressionLevelsValueObject(BaseModel):
    """
    ResponseDataObjectListExperimentExpressionLevelsValueObject
    """
    data: Optional[conlist(ExperimentExpressionLevelsValueObject)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResponseDataObjectListExperimentExpressionLevelsValueObject:
        """Create an instance of ResponseDataObjectListExperimentExpressionLevelsValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResponseDataObjectListExperimentExpressionLevelsValueObject:
        """Create an instance of ResponseDataObjectListExperimentExpressionLevelsValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResponseDataObjectListExperimentExpressionLevelsValueObject.parse_obj(obj)

        _obj = ResponseDataObjectListExperimentExpressionLevelsValueObject.parse_obj({
            "data": [ExperimentExpressionLevelsValueObject.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
