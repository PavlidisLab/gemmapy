...
class ExpressionExperimentValueObject(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExpressionExperimentValueObject:
        """Create an instance of ExpressionExperimentValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExpressionExperimentValueObject:
        """Create an instance of ExpressionExperimentValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExpressionExperimentValueObject.parse_obj(obj)

        _obj = ExpressionExperimentValueObject.parse_obj({
            "id": obj.get("id"),
