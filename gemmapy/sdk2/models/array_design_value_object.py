...
class ArrayDesignValueObject(BaseModel):
    """
    ...
    expression_experiment_count: Optional[StrictInt] = Field(None, alias="expressionExperimentCount")
    is_merged: Optional[StrictBool] = Field(None, alias="isMerged")
    is_mergee: Optional[StrictBool] = Field(None, alias="isMergee")
    ...
    release_version: Optional[StrictStr] = Field(None, alias="releaseVersion")
    release_url: Optional[StrictStr] = Field(None, alias="releaseUrl")
    external_references: Optional[conlist(DatabaseEntryValueObject, unique_items=True)] = Field(None, alias="externalReferences")
    number_of_expression_experiments: Optional[StrictInt] = Field(None, alias="numberOfExpressionExperiments")
    taxon_id: Optional[StrictInt] = Field(None, alias="taxonID")
    trouble_details: Optional[StrictStr] = Field(None, alias="troubleDetails")
    number_of_switched_expression_experiments: Optional[StrictInt] = Field(None, alias="numberOfSwitchedExpressionExperiments")
    taxon: Optional[TaxonValueObject] = None
    __properties = ["id", "lastUpdated", "troubled", "lastTroubledEvent", "needsAttention", "lastNeedsAttentionEvent", "curationNote", "lastNoteUpdateEvent", "color", "description", "expressionExperimentCount", "isMerged", "isMergee", "name", "shortName", "technologyType", "releaseVersion", "releaseUrl", "externalReferences", "numberOfExpressionExperiments", "taxonID", "troubleDetails", "numberOfSwitchedExpressionExperiments", "taxon"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ArrayDesignValueObject:
        """Create an instance of ArrayDesignValueObject from a JSON string"""
    ...
    def to_dict(self):
        ...
        if self.external_references:
            for _item in self.external_references:
                if _item:
                    _items.append(_item.to_dict())
            _dict['externalReferences'] = _items
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ArrayDesignValueObject:
        """Create an instance of ArrayDesignValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ArrayDesignValueObject.parse_obj(obj)

        _obj = ArrayDesignValueObject.parse_obj({
            "id": obj.get("id"),
            ...
            "expression_experiment_count": obj.get("expressionExperimentCount"),
            "is_merged": obj.get("isMerged"),
            "is_mergee": obj.get("isMergee"),
            "name": obj.get("name"),
            "short_name": obj.get("shortName"),
            "technology_type": obj.get("technologyType"),
            "release_version": obj.get("releaseVersion"),
            "release_url": obj.get("releaseUrl"),
            "external_references": [DatabaseEntryValueObject.from_dict(_item) for _item in obj.get("externalReferences")] if obj.get("externalReferences") is not None else None,
            "number_of_expression_experiments": obj.get("numberOfExpressionExperiments"),
            "taxon_id": obj.get("taxonID"),
            "trouble_details": obj.get("troubleDetails"),
            "number_of_switched_expression_experiments": obj.get("numberOfSwitchedExpressionExperiments"),
