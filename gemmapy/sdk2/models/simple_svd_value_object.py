...
class SimpleSVDValueObject(BaseModel):
    """
    SimpleSVDValueObject
    """
    bio_material_ids: Optional[conlist(StrictInt)] = Field(None, alias="bioMaterialIds")
    variances: Optional[conlist(Union[StrictFloat, StrictInt])] = None
    vmatrix: Optional[conlist(conlist(Union[StrictFloat, StrictInt]))] = None
    __properties = ["bioMaterialIds", "variances", "vmatrix"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SimpleSVDValueObject:
        """Create an instance of SimpleSVDValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SimpleSVDValueObject:
        """Create an instance of SimpleSVDValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SimpleSVDValueObject.parse_obj(obj)

        _obj = SimpleSVDValueObject.parse_obj({
            "bio_material_ids": obj.get("bioMaterialIds"),
            "variances": obj.get("variances"),
            "vmatrix": obj.get("vmatrix")
        })
        return _obj
