...
class ResponseErrorObject(BaseModel):
    ...
    ResponseErrorObject
    """
    error: Optional[WellComposedErrorBody] = None
    api_version: Optional[StrictStr] = Field(None, alias="apiVersion")
    __properties = ["error", "apiVersion"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResponseErrorObject:
        """Create an instance of ResponseErrorObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResponseErrorObject:
        """Create an instance of ResponseErrorObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResponseErrorObject.parse_obj(obj)

        _obj = ResponseErrorObject.parse_obj({
            "error": WellComposedErrorBody.from_dict(obj.get("error")) if obj.get("error") is not None else None,
