...
class ExpressionExperimentSetValueObject(BaseModel):
    """
    ExpressionExperimentSetValueObject
    """
    id: Optional[StrictInt] = None
    description: Optional[StrictStr] = None
    expression_experiment_ids: Optional[conlist(StrictInt)] = Field(None, alias="expressionExperimentIds")
    is_public: Optional[StrictBool] = Field(None, alias="isPublic")
    modifiable: Optional[StrictBool] = None
    name: Optional[StrictStr] = None
    size: Optional[StrictInt] = None
    num_with_coexpression_analysis: Optional[StrictInt] = Field(None, alias="numWithCoexpressionAnalysis")
    num_with_differential_expression_analysis: Optional[StrictInt] = Field(None, alias="numWithDifferentialExpressionAnalysis")
    taxon_id: Optional[StrictInt] = Field(None, alias="taxonId")
    taxon_name: Optional[StrictStr] = Field(None, alias="taxonName")
    user_can_write: Optional[StrictBool] = Field(None, alias="userCanWrite")
    user_owned: Optional[StrictBool] = Field(None, alias="userOwned")
    is_shared: Optional[StrictBool] = Field(None, alias="isShared")
    __properties = ["id", "description", "expressionExperimentIds", "isPublic", "modifiable", "name", "size", "numWithCoexpressionAnalysis", "numWithDifferentialExpressionAnalysis", "taxonId", "taxonName", "userCanWrite", "userOwned", "isShared"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExpressionExperimentSetValueObject:
        """Create an instance of ExpressionExperimentSetValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExpressionExperimentSetValueObject:
        """Create an instance of ExpressionExperimentSetValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExpressionExperimentSetValueObject.parse_obj(obj)

        _obj = ExpressionExperimentSetValueObject.parse_obj({
            "id": obj.get("id"),
            "description": obj.get("description"),
            "expression_experiment_ids": obj.get("expressionExperimentIds"),
            "is_public": obj.get("isPublic"),
            "modifiable": obj.get("modifiable"),
            "name": obj.get("name"),
            "size": obj.get("size"),
            "num_with_coexpression_analysis": obj.get("numWithCoexpressionAnalysis"),
            "num_with_differential_expression_analysis": obj.get("numWithDifferentialExpressionAnalysis"),
            "taxon_id": obj.get("taxonId"),
            "taxon_name": obj.get("taxonName"),
            "user_can_write": obj.get("userCanWrite"),
            "user_owned": obj.get("userOwned"),
            "is_shared": obj.get("isShared")
        })
        return _obj
