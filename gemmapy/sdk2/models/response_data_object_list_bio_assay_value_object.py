...
class ResponseDataObjectListBioAssayValueObject(BaseModel):
    """
    ResponseDataObjectListBioAssayValueObject
    """
    data: Optional[conlist(BioAssayValueObject)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResponseDataObjectListBioAssayValueObject:
        """Create an instance of ResponseDataObjectListBioAssayValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResponseDataObjectListBioAssayValueObject:
        """Create an instance of ResponseDataObjectListBioAssayValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResponseDataObjectListBioAssayValueObject.parse_obj(obj)

        _obj = ResponseDataObjectListBioAssayValueObject.parse_obj({
            "data": [BioAssayValueObject.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
