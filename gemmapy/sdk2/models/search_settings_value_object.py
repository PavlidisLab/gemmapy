...
class SearchSettingsValueObject(BaseModel):
    """
    SearchSettingsValueObject
    """
    query: Optional[StrictStr] = None
    result_types: Optional[conlist(conlist(StrictStr))] = Field(None, alias="resultTypes")
    taxon: Optional[TaxonValueObject] = None
    platform: Optional[ArrayDesignValueObject] = None
    max_results: Optional[StrictInt] = Field(None, alias="maxResults")
    __properties = ["query", "resultTypes", "taxon", "platform", "maxResults"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SearchSettingsValueObject:
        """Create an instance of SearchSettingsValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SearchSettingsValueObject:
        """Create an instance of SearchSettingsValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SearchSettingsValueObject.parse_obj(obj)

        _obj = SearchSettingsValueObject.parse_obj({
            "query": obj.get("query"),
            "result_types": obj.get("resultTypes"),
            "taxon": TaxonValueObject.from_dict(obj.get("taxon")) if obj.get("taxon") is not None else None,
            "platform": ArrayDesignValueObject.from_dict(obj.get("platform")) if obj.get("platform") is not None else None,
