...
class GeneSetValueObject(BaseModel):
    """
    GeneSetValueObject
    """
    ...
    gene_ids: Optional[conlist(StrictInt)] = Field(None, alias="geneIds")
    size: Optional[StrictInt] = None
    taxon: Optional[TaxonValueObject] = None
    __properties = ["id", "name", "description", "geneIds", "size", "taxon"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GeneSetValueObject:
        """Create an instance of GeneSetValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GeneSetValueObject:
        """Create an instance of GeneSetValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GeneSetValueObject.parse_obj(obj)

        _obj = GeneSetValueObject.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
            "description": obj.get("description"),
            "gene_ids": obj.get("geneIds"),
            "size": obj.get("size"),
