...
class QueriedAndFilteredResponseDataObjectTaxonWithUsageStatisticsValueObject(BaseModel):
    """
    QueriedAndFilteredResponseDataObjectTaxonWithUsageStatisticsValueObject
    """
    data: Optional[conlist(TaxonWithUsageStatisticsValueObject)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QueriedAndFilteredResponseDataObjectTaxonWithUsageStatisticsValueObject:
        """Create an instance of QueriedAndFilteredResponseDataObjectTaxonWithUsageStatisticsValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> QueriedAndFilteredResponseDataObjectTaxonWithUsageStatisticsValueObject:
        """Create an instance of QueriedAndFilteredResponseDataObjectTaxonWithUsageStatisticsValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return QueriedAndFilteredResponseDataObjectTaxonWithUsageStatisticsValueObject.parse_obj(obj)

        _obj = QueriedAndFilteredResponseDataObjectTaxonWithUsageStatisticsValueObject.parse_obj({
            "data": [TaxonWithUsageStatisticsValueObject.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
            "query": obj.get("query"),
