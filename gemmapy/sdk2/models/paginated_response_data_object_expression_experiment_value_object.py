...
class PaginatedResponseDataObjectExpressionExperimentValueObject(BaseModel):
    """
    ...
    __properties = ["data", "groupBy", "sort", "offset", "limit", "totalElements"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PaginatedResponseDataObjectExpressionExperimentValueObject:
        """Create an instance of PaginatedResponseDataObjectExpressionExperimentValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PaginatedResponseDataObjectExpressionExperimentValueObject:
        """Create an instance of PaginatedResponseDataObjectExpressionExperimentValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PaginatedResponseDataObjectExpressionExperimentValueObject.parse_obj(obj)

        _obj = PaginatedResponseDataObjectExpressionExperimentValueObject.parse_obj({
