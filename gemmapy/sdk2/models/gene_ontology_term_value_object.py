...
class GeneOntologyTermValueObject(BaseModel):
    """
    GeneOntologyTermValueObject
    """
    go_id: Optional[StrictStr] = Field(None, alias="goId")
    label: Optional[StrictStr] = None
    uri: Optional[StrictStr] = None
    comment: Optional[StrictStr] = None
    local_name: Optional[StrictStr] = Field(None, alias="localName")
    term: Optional[StrictStr] = None
    obsolete: Optional[StrictBool] = None
    __properties = ["goId", "label", "uri", "comment", "localName", "term", "obsolete"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GeneOntologyTermValueObject:
        """Create an instance of GeneOntologyTermValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GeneOntologyTermValueObject:
        """Create an instance of GeneOntologyTermValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GeneOntologyTermValueObject.parse_obj(obj)

        _obj = GeneOntologyTermValueObject.parse_obj({
            "go_id": obj.get("goId"),
            "label": obj.get("label"),
            "uri": obj.get("uri"),
