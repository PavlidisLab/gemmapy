...
class CitationValueObject(BaseModel):
    """
    CitationValueObject
    """
    citation: Optional[StrictStr] = None
    id: Optional[StrictInt] = None
    pubmed_accession: Optional[StrictStr] = Field(None, alias="pubmedAccession")
    pubmed_url: Optional[StrictStr] = Field(None, alias="pubmedURL")
    retracted: Optional[StrictBool] = None
    __properties = ["citation", "id", "pubmedAccession", "pubmedURL", "retracted"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CitationValueObject:
        """Create an instance of CitationValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CitationValueObject:
        """Create an instance of CitationValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CitationValueObject.parse_obj(obj)

        _obj = CitationValueObject.parse_obj({
            "citation": obj.get("citation"),
            "id": obj.get("id"),
            "pubmed_accession": obj.get("pubmedAccession"),
            "pubmed_url": obj.get("pubmedURL"),
