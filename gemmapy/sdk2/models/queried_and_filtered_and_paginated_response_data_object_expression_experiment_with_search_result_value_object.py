...
class QueriedAndFilteredAndPaginatedResponseDataObjectExpressionExperimentWithSearchResultValueObject(BaseModel):
    """
    QueriedAndFilteredAndPaginatedResponseDataObjectExpressionExperimentWithSearchResultValueObject
    """
    data: Optional[conlist(ExpressionExperimentWithSearchResultValueObject)] = None
    query: Optional[StrictStr] = None
    filter: Optional[StrictStr] = None
    group_by: Optional[conlist(StrictStr)] = Field(None, alias="groupBy")
    sort: Optional[SortValueObject] = None
    offset: Optional[StrictInt] = None
    limit: Optional[StrictInt] = None
    total_elements: Optional[StrictInt] = Field(None, alias="totalElements")
    __properties = ["data", "query", "filter", "groupBy", "sort", "offset", "limit", "totalElements"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QueriedAndFilteredAndPaginatedResponseDataObjectExpressionExperimentWithSearchResultValueObject:
        """Create an instance of QueriedAndFilteredAndPaginatedResponseDataObjectExpressionExperimentWithSearchResultValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> QueriedAndFilteredAndPaginatedResponseDataObjectExpressionExperimentWithSearchResultValueObject:
        """Create an instance of QueriedAndFilteredAndPaginatedResponseDataObjectExpressionExperimentWithSearchResultValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return QueriedAndFilteredAndPaginatedResponseDataObjectExpressionExperimentWithSearchResultValueObject.parse_obj(obj)

        _obj = QueriedAndFilteredAndPaginatedResponseDataObjectExpressionExperimentWithSearchResultValueObject.parse_obj({
            "data": [ExpressionExperimentWithSearchResultValueObject.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
            "query": obj.get("query"),
            "filter": obj.get("filter"),
            "group_by": obj.get("groupBy"),
            "sort": SortValueObject.from_dict(obj.get("sort")) if obj.get("sort") is not None else None,
