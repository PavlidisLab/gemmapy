...
class ResponseDataObjectDifferentialExpressionAnalysisResultSetValueObject(BaseModel):
    """
    ResponseDataObjectDifferentialExpressionAnalysisResultSetValueObject
    """
    data: Optional[DifferentialExpressionAnalysisResultSetValueObject] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResponseDataObjectDifferentialExpressionAnalysisResultSetValueObject:
        """Create an instance of ResponseDataObjectDifferentialExpressionAnalysisResultSetValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResponseDataObjectDifferentialExpressionAnalysisResultSetValueObject:
        """Create an instance of ResponseDataObjectDifferentialExpressionAnalysisResultSetValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResponseDataObjectDifferentialExpressionAnalysisResultSetValueObject.parse_obj(obj)

        _obj = ResponseDataObjectDifferentialExpressionAnalysisResultSetValueObject.parse_obj({
            "data": DifferentialExpressionAnalysisResultSetValueObject.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
