...
class FilteredAndPaginatedResponseDataObjectExpressionExperimentValueObject(BaseModel):
    """
    FilteredAndPaginatedResponseDataObjectExpressionExperimentValueObject
    """
    data: Optional[conlist(ExpressionExperimentValueObject)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FilteredAndPaginatedResponseDataObjectExpressionExperimentValueObject:
        """Create an instance of FilteredAndPaginatedResponseDataObjectExpressionExperimentValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FilteredAndPaginatedResponseDataObjectExpressionExperimentValueObject:
        """Create an instance of FilteredAndPaginatedResponseDataObjectExpressionExperimentValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FilteredAndPaginatedResponseDataObjectExpressionExperimentValueObject.parse_obj(obj)

        _obj = FilteredAndPaginatedResponseDataObjectExpressionExperimentValueObject.parse_obj({
            "data": [ExpressionExperimentValueObject.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
