...
class ResponseDataObjectLong(BaseModel):
    """
    ResponseDataObjectLong
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResponseDataObjectLong:
        """Create an instance of ResponseDataObjectLong from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResponseDataObjectLong:
        """Create an instance of ResponseDataObjectLong from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResponseDataObjectLong.parse_obj(obj)

        _obj = ResponseDataObjectLong.parse_obj({
            "data": obj.get("data")
        })
        return _obj
