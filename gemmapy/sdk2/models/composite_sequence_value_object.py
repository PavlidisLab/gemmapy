...
class CompositeSequenceValueObject(BaseModel):
    """
    ...
    __properties = ["id", "name", "description", "arrayDesign"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CompositeSequenceValueObject:
        """Create an instance of CompositeSequenceValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CompositeSequenceValueObject:
        """Create an instance of CompositeSequenceValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CompositeSequenceValueObject.parse_obj(obj)

        _obj = CompositeSequenceValueObject.parse_obj({
            "id": obj.get("id"),
            "name": obj.get("name"),
