...
class CharacteristicValueObject(BaseModel):
    """
    ...
    __properties = ["id", "category", "categoryUri", "value", "valueUri"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CharacteristicValueObject:
        """Create an instance of CharacteristicValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CharacteristicValueObject:
        """Create an instance of CharacteristicValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CharacteristicValueObject.parse_obj(obj)

        _obj = CharacteristicValueObject.parse_obj({
            "id": obj.get("id"),
