...
from pydantic import BaseModel, Field, StrictBool, StrictBytes, StrictFloat, StrictInt, StrictStr

class GeeqValueObject(BaseModel):
    """
    GeeqValueObject
    """
    id: Optional[StrictInt] = None
    public_quality_score: Optional[Union[StrictFloat, StrictInt]] = Field(None, alias="publicQualityScore")
    public_suitability_score: Optional[Union[StrictFloat, StrictInt]] = Field(None, alias="publicSuitabilityScore")
    no_vectors: Optional[StrictBool] = Field(None, alias="noVectors")
    corr_mat_issues: Optional[Union[StrictBytes, StrictStr]] = Field(None, alias="corrMatIssues")
    replicates_issues: Optional[Union[StrictBytes, StrictStr]] = Field(None, alias="replicatesIssues")
    batch_corrected: Optional[StrictBool] = Field(None, alias="batchCorrected")
    s_score_publication: Optional[Union[StrictFloat, StrictInt]] = Field(None, alias="sScorePublication")
    s_score_platform_amount: Optional[Union[StrictFloat, StrictInt]] = Field(None, alias="sScorePlatformAmount")
    s_score_platform_tech_multi: Optional[Union[StrictFloat, StrictInt]] = Field(None, alias="sScorePlatformTechMulti")
    s_score_avg_platform_popularity: Optional[Union[StrictFloat, StrictInt]] = Field(None, alias="sScoreAvgPlatformPopularity")
    s_score_avg_platform_size: Optional[Union[StrictFloat, StrictInt]] = Field(None, alias="sScoreAvgPlatformSize")
    s_score_sample_size: Optional[Union[StrictFloat, StrictInt]] = Field(None, alias="sScoreSampleSize")
    s_score_raw_data: Optional[Union[StrictFloat, StrictInt]] = Field(None, alias="sScoreRawData")
    s_score_missing_values: Optional[Union[StrictFloat, StrictInt]] = Field(None, alias="sScoreMissingValues")
    q_score_outliers: Optional[Union[StrictFloat, StrictInt]] = Field(None, alias="qScoreOutliers")
    q_score_sample_mean_correlation: Optional[Union[StrictFloat, StrictInt]] = Field(None, alias="qScoreSampleMeanCorrelation")
    q_score_sample_median_correlation: Optional[Union[StrictFloat, StrictInt]] = Field(None, alias="qScoreSampleMedianCorrelation")
    q_score_sample_correlation_variance: Optional[Union[StrictFloat, StrictInt]] = Field(None, alias="qScoreSampleCorrelationVariance")
    q_score_platforms_tech: Optional[Union[StrictFloat, StrictInt]] = Field(None, alias="qScorePlatformsTech")
    q_score_replicates: Optional[Union[StrictFloat, StrictInt]] = Field(None, alias="qScoreReplicates")
    q_score_batch_info: Optional[Union[StrictFloat, StrictInt]] = Field(None, alias="qScoreBatchInfo")
    q_score_public_batch_effect: Optional[Union[StrictFloat, StrictInt]] = Field(None, alias="qScorePublicBatchEffect")
    q_score_public_batch_confound: Optional[Union[StrictFloat, StrictInt]] = Field(None, alias="qScorePublicBatchConfound")
    __properties = ["id", "publicQualityScore", "publicSuitabilityScore", "noVectors", "corrMatIssues", "replicatesIssues", "batchCorrected", "sScorePublication", "sScorePlatformAmount", "sScorePlatformTechMulti", "sScoreAvgPlatformPopularity", "sScoreAvgPlatformSize", "sScoreSampleSize", "sScoreRawData", "sScoreMissingValues", "qScoreOutliers", "qScoreSampleMeanCorrelation", "qScoreSampleMedianCorrelation", "qScoreSampleCorrelationVariance", "qScorePlatformsTech", "qScoreReplicates", "qScoreBatchInfo", "qScorePublicBatchEffect", "qScorePublicBatchConfound"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> GeeqValueObject:
        """Create an instance of GeeqValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> GeeqValueObject:
        """Create an instance of GeeqValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return GeeqValueObject.parse_obj(obj)

        _obj = GeeqValueObject.parse_obj({
            "id": obj.get("id"),
            "public_quality_score": obj.get("publicQualityScore"),
            "public_suitability_score": obj.get("publicSuitabilityScore"),
            "no_vectors": obj.get("noVectors"),
            "corr_mat_issues": obj.get("corrMatIssues"),
            "replicates_issues": obj.get("replicatesIssues"),
            "batch_corrected": obj.get("batchCorrected"),
            "s_score_publication": obj.get("sScorePublication"),
            "s_score_platform_amount": obj.get("sScorePlatformAmount"),
            "s_score_platform_tech_multi": obj.get("sScorePlatformTechMulti"),
            "s_score_avg_platform_popularity": obj.get("sScoreAvgPlatformPopularity"),
            "s_score_avg_platform_size": obj.get("sScoreAvgPlatformSize"),
            "s_score_sample_size": obj.get("sScoreSampleSize"),
            "s_score_raw_data": obj.get("sScoreRawData"),
            "s_score_missing_values": obj.get("sScoreMissingValues"),
            "q_score_outliers": obj.get("qScoreOutliers"),
            "q_score_sample_mean_correlation": obj.get("qScoreSampleMeanCorrelation"),
            "q_score_sample_median_correlation": obj.get("qScoreSampleMedianCorrelation"),
            "q_score_sample_correlation_variance": obj.get("qScoreSampleCorrelationVariance"),
            "q_score_platforms_tech": obj.get("qScorePlatformsTech"),
            "q_score_replicates": obj.get("qScoreReplicates"),
            "q_score_batch_info": obj.get("qScoreBatchInfo"),
            "q_score_public_batch_effect": obj.get("qScorePublicBatchEffect"),
            "q_score_public_batch_confound": obj.get("qScorePublicBatchConfound")
        })
        return _obj
