...
class ResponseDataObjectListTaxonValueObject(BaseModel):
    """
    ResponseDataObjectListTaxonValueObject
    """
    data: Optional[conlist(TaxonValueObject)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResponseDataObjectListTaxonValueObject:
        """Create an instance of ResponseDataObjectListTaxonValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResponseDataObjectListTaxonValueObject:
        """Create an instance of ResponseDataObjectListTaxonValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResponseDataObjectListTaxonValueObject.parse_obj(obj)

        _obj = ResponseDataObjectListTaxonValueObject.parse_obj({
            "data": [TaxonValueObject.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
