...
class FilteredAndPaginatedResponseDataObjectCompositeSequenceValueObject(BaseModel):
    """
    FilteredAndPaginatedResponseDataObjectCompositeSequenceValueObject
    """
    data: Optional[conlist(CompositeSequenceValueObject)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> FilteredAndPaginatedResponseDataObjectCompositeSequenceValueObject:
        """Create an instance of FilteredAndPaginatedResponseDataObjectCompositeSequenceValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> FilteredAndPaginatedResponseDataObjectCompositeSequenceValueObject:
        """Create an instance of FilteredAndPaginatedResponseDataObjectCompositeSequenceValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return FilteredAndPaginatedResponseDataObjectCompositeSequenceValueObject.parse_obj(obj)

        _obj = FilteredAndPaginatedResponseDataObjectCompositeSequenceValueObject.parse_obj({
            "data": [CompositeSequenceValueObject.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
