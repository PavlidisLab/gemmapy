...
class BibliographicReferenceValueObject(BaseModel):
    """
    BibliographicReferenceValueObject
    """
    id: Optional[StrictInt] = None
    abstract_text: Optional[StrictStr] = Field(None, alias="abstractText")
    author_list: Optional[StrictStr] = Field(None, alias="authorList")
    citation: Optional[CitationValueObject] = None
    experiments: Optional[conlist(ExpressionExperimentValueObject)] = None
    issue: Optional[StrictStr] = None
    pages: Optional[StrictStr] = None
    pub_accession: Optional[StrictStr] = Field(None, alias="pubAccession")
    ...
    mesh_terms: Optional[conlist(StrictStr)] = Field(None, alias="meshTerms")
    chemicals_terms: Optional[conlist(StrictStr)] = Field(None, alias="chemicalsTerms")
    bibliographic_phenotypes: Optional[conlist(BibliographicPhenotypesValueObject)] = Field(None, alias="bibliographicPhenotypes")
    retracted: Optional[StrictBool] = None
    __properties = ["id", "abstractText", "authorList", "citation", "experiments", "issue", "pages", "pubAccession", "publication", "publicationDate", "publisher", "title", "volume", "meshTerms", "chemicalsTerms", "bibliographicPhenotypes", "retracted"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BibliographicReferenceValueObject:
        """Create an instance of BibliographicReferenceValueObject from a JSON string"""
    ...
    def to_dict(self):
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in bibliographic_phenotypes (list)
        _items = []
        if self.bibliographic_phenotypes:
            for _item in self.bibliographic_phenotypes:
                if _item:
                    _items.append(_item.to_dict())
            _dict['bibliographicPhenotypes'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> BibliographicReferenceValueObject:
        """Create an instance of BibliographicReferenceValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BibliographicReferenceValueObject.parse_obj(obj)

        _obj = BibliographicReferenceValueObject.parse_obj({
            "id": obj.get("id"),
            "abstract_text": obj.get("abstractText"),
            "author_list": obj.get("authorList"),
            "citation": CitationValueObject.from_dict(obj.get("citation")) if obj.get("citation") is not None else None,
            "experiments": [ExpressionExperimentValueObject.from_dict(_item) for _item in obj.get("experiments")] if obj.get("experiments") is not None else None,
            "issue": obj.get("issue"),
            "pages": obj.get("pages"),
            "pub_accession": obj.get("pubAccession"),
            "publication": obj.get("publication"),
            "publication_date": obj.get("publicationDate"),
            "publisher": obj.get("publisher"),
            "title": obj.get("title"),
            "volume": obj.get("volume"),
            "mesh_terms": obj.get("meshTerms"),
            "chemicals_terms": obj.get("chemicalsTerms"),
            "bibliographic_phenotypes": [BibliographicPhenotypesValueObject.from_dict(_item) for _item in obj.get("bibliographicPhenotypes")] if obj.get("bibliographicPhenotypes") is not None else None,
