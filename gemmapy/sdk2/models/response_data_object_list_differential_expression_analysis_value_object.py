...
class ResponseDataObjectListDifferentialExpressionAnalysisValueObject(BaseModel):
    """
    ResponseDataObjectListDifferentialExpressionAnalysisValueObject
    """
    data: Optional[conlist(DifferentialExpressionAnalysisValueObject)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResponseDataObjectListDifferentialExpressionAnalysisValueObject:
        """Create an instance of ResponseDataObjectListDifferentialExpressionAnalysisValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResponseDataObjectListDifferentialExpressionAnalysisValueObject:
        """Create an instance of ResponseDataObjectListDifferentialExpressionAnalysisValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResponseDataObjectListDifferentialExpressionAnalysisValueObject.parse_obj(obj)

        _obj = ResponseDataObjectListDifferentialExpressionAnalysisValueObject.parse_obj({
            "data": [DifferentialExpressionAnalysisValueObject.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
