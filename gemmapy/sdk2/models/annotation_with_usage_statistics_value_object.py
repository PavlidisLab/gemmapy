...
class AnnotationWithUsageStatisticsValueObject(BaseModel):
    """
    AnnotationWithUsageStatisticsValueObject
    """
    class_uri: Optional[StrictStr] = Field(None, alias="classUri")
    class_name: Optional[StrictStr] = Field(None, alias="className")
    term_uri: Optional[StrictStr] = Field(None, alias="termUri")
    term_name: Optional[StrictStr] = Field(None, alias="termName")
    evidence_code: Optional[StrictStr] = Field(None, alias="evidenceCode")
    number_of_expression_experiments: Optional[StrictInt] = Field(None, alias="numberOfExpressionExperiments")
    parent_terms: Optional[conlist(OntologyTermValueObject, unique_items=True)] = Field(None, alias="parentTerms")
    __properties = ["classUri", "className", "termUri", "termName", "evidenceCode", "numberOfExpressionExperiments", "parentTerms"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AnnotationWithUsageStatisticsValueObject:
        """Create an instance of AnnotationWithUsageStatisticsValueObject from a JSON string"""
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic by calling `to_dict()` of each item in parent_terms (list)
        _items = []
        if self.parent_terms:
            for _item in self.parent_terms:
                if _item:
                    _items.append(_item.to_dict())
            _dict['parentTerms'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> AnnotationWithUsageStatisticsValueObject:
        """Create an instance of AnnotationWithUsageStatisticsValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AnnotationWithUsageStatisticsValueObject.parse_obj(obj)

        _obj = AnnotationWithUsageStatisticsValueObject.parse_obj({
            "class_uri": obj.get("classUri"),
            "class_name": obj.get("className"),
            "term_uri": obj.get("termUri"),
            "term_name": obj.get("termName"),
            "evidence_code": obj.get("evidenceCode"),
            "number_of_expression_experiments": obj.get("numberOfExpressionExperiments"),
            "parent_terms": [OntologyTermValueObject.from_dict(_item) for _item in obj.get("parentTerms")] if obj.get("parentTerms") is not None else None
        })
        return _obj
