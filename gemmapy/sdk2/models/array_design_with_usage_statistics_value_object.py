...
class ArrayDesignWithUsageStatisticsValueObject(BaseModel):
    """
    ...
    number_of_expression_experiments_for_technology_type: Optional[StrictInt] = Field(None, alias="numberOfExpressionExperimentsForTechnologyType")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ArrayDesignWithUsageStatisticsValueObject:
        """Create an instance of ArrayDesignWithUsageStatisticsValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ArrayDesignWithUsageStatisticsValueObject:
        """Create an instance of ArrayDesignWithUsageStatisticsValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ArrayDesignWithUsageStatisticsValueObject.parse_obj(obj)

        _obj = ArrayDesignWithUsageStatisticsValueObject.parse_obj({
            "id": obj.get("id"),
            ...
            "number_of_expression_experiments_for_technology_type": obj.get("numberOfExpressionExperimentsForTechnologyType"),
