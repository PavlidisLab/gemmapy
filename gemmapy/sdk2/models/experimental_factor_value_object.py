...
class ExperimentalFactorValueObject(BaseModel):
    """
    ...
    factor_values: Optional[StrictStr] = Field(None, alias="factorValues")
    name: Optional[StrictStr] = None
    type: Optional[StrictStr] = None
    values: Optional[conlist(FactorValueValueObject)] = None
    __properties = ["id", "category", "categoryUri", "description", "factorValues", "name", "type", "values"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExperimentalFactorValueObject:
        """Create an instance of ExperimentalFactorValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExperimentalFactorValueObject:
        """Create an instance of ExperimentalFactorValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExperimentalFactorValueObject.parse_obj(obj)

        _obj = ExperimentalFactorValueObject.parse_obj({
            "id": obj.get("id"),
            "category": obj.get("category"),
            "category_uri": obj.get("categoryUri"),
            "description": obj.get("description"),
            "factor_values": obj.get("factorValues"),
            "name": obj.get("name"),
            "type": obj.get("type"),
            "values": [FactorValueValueObject.from_dict(_item) for _item in obj.get("values")] if obj.get("values") is not None else None
        })
        return _obj
