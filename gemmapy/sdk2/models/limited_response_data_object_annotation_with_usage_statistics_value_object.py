...
class LimitedResponseDataObjectAnnotationWithUsageStatisticsValueObject(BaseModel):
    """
    LimitedResponseDataObjectAnnotationWithUsageStatisticsValueObject
    """
    data: Optional[conlist(AnnotationWithUsageStatisticsValueObject)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LimitedResponseDataObjectAnnotationWithUsageStatisticsValueObject:
        """Create an instance of LimitedResponseDataObjectAnnotationWithUsageStatisticsValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LimitedResponseDataObjectAnnotationWithUsageStatisticsValueObject:
        """Create an instance of LimitedResponseDataObjectAnnotationWithUsageStatisticsValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LimitedResponseDataObjectAnnotationWithUsageStatisticsValueObject.parse_obj(obj)

        _obj = LimitedResponseDataObjectAnnotationWithUsageStatisticsValueObject.parse_obj({
            "data": [AnnotationWithUsageStatisticsValueObject.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
            "query": obj.get("query"),
