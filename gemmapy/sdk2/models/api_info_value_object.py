...
class ApiInfoValueObject(BaseModel):
    """
    ApiInfoValueObject
    """
    ...
    external_databases: Optional[conlist(ExternalDatabaseValueObject)] = Field(None, alias="externalDatabases")
    __properties = ["welcome", "version", "docs", "externalDatabases"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ApiInfoValueObject:
        """Create an instance of ApiInfoValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ApiInfoValueObject:
        """Create an instance of ApiInfoValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ApiInfoValueObject.parse_obj(obj)

        _obj = ApiInfoValueObject.parse_obj({
