...
class QueriedAndFilteredResponseDataObjectCategoryWithUsageStatisticsValueObject(BaseModel):
    """
    QueriedAndFilteredResponseDataObjectCategoryWithUsageStatisticsValueObject
    """
    data: Optional[conlist(CategoryWithUsageStatisticsValueObject)] = None
    query: Optional[StrictStr] = None
    filter: Optional[StrictStr] = None
    group_by: Optional[conlist(StrictStr)] = Field(None, alias="groupBy")
    sort: Optional[StrictStr] = None
    __properties = ["data", "query", "filter", "groupBy", "sort"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QueriedAndFilteredResponseDataObjectCategoryWithUsageStatisticsValueObject:
        """Create an instance of QueriedAndFilteredResponseDataObjectCategoryWithUsageStatisticsValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> QueriedAndFilteredResponseDataObjectCategoryWithUsageStatisticsValueObject:
        """Create an instance of QueriedAndFilteredResponseDataObjectCategoryWithUsageStatisticsValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return QueriedAndFilteredResponseDataObjectCategoryWithUsageStatisticsValueObject.parse_obj(obj)

        _obj = QueriedAndFilteredResponseDataObjectCategoryWithUsageStatisticsValueObject.parse_obj({
            "data": [CategoryWithUsageStatisticsValueObject.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
            "query": obj.get("query"),
