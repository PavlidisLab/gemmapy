...
class DifferentialExpressionAnalysisResultSetValueObject(BaseModel):
    """
    DifferentialExpressionAnalysisResultSetValueObject
    """
    id: Optional[StrictInt] = None
    analysis: Optional[DifferentialExpressionAnalysisValueObject] = None
    experimental_factors: Optional[conlist(ExperimentalFactorValueObject)] = Field(None, alias="experimentalFactors")
    baseline_group: Optional[FactorValueBasicValueObject] = Field(None, alias="baselineGroup")
    results: Optional[conlist(DifferentialExpressionAnalysisResultValueObject)] = None
    __properties = ["id", "analysis", "experimentalFactors", "baselineGroup", "results"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DifferentialExpressionAnalysisResultSetValueObject:
        """Create an instance of DifferentialExpressionAnalysisResultSetValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DifferentialExpressionAnalysisResultSetValueObject:
        """Create an instance of DifferentialExpressionAnalysisResultSetValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DifferentialExpressionAnalysisResultSetValueObject.parse_obj(obj)

        _obj = DifferentialExpressionAnalysisResultSetValueObject.parse_obj({
            "id": obj.get("id"),
            "analysis": DifferentialExpressionAnalysisValueObject.from_dict(obj.get("analysis")) if obj.get("analysis") is not None else None,
            ...
            "baseline_group": FactorValueBasicValueObject.from_dict(obj.get("baselineGroup")) if obj.get("baselineGroup") is not None else None,
            "results": [DifferentialExpressionAnalysisResultValueObject.from_dict(_item) for _item in obj.get("results")] if obj.get("results") is not None else None
        })
        return _obj
