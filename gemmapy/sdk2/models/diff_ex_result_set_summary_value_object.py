...
class DiffExResultSetSummaryValueObject(BaseModel):
    """
    DiffExResultSetSummaryValueObject
    """
    id: Optional[StrictInt] = None
    array_designs_used: Optional[conlist(StrictInt)] = Field(None, alias="arrayDesignsUsed")
    baseline_group: Optional[FactorValueValueObject] = Field(None, alias="baselineGroup")
    experimental_factors: Optional[conlist(ExperimentalFactorValueObject)] = Field(None, alias="experimentalFactors")
    number_of_genes_analyzed: Optional[StrictInt] = Field(None, alias="numberOfGenesAnalyzed")
    number_of_probes_analyzed: Optional[StrictInt] = Field(None, alias="numberOfProbesAnalyzed")
    threshold: Optional[Union[StrictFloat, StrictInt]] = None
    number_of_diff_expressed_probes: Optional[StrictInt] = Field(None, alias="numberOfDiffExpressedProbes")
    upregulated_count: Optional[StrictInt] = Field(None, alias="upregulatedCount")
    downregulated_count: Optional[StrictInt] = Field(None, alias="downregulatedCount")
    qvalue: Optional[Union[StrictFloat, StrictInt]] = None
    number_of_upregulated_probes: Optional[StrictInt] = Field(None, alias="numberOfUpregulatedProbes")
    number_of_downregulated_probes: Optional[StrictInt] = Field(None, alias="numberOfDownregulatedProbes")
    __properties = ["id", "arrayDesignsUsed", "baselineGroup", "experimentalFactors", "numberOfGenesAnalyzed", "numberOfProbesAnalyzed", "threshold", "numberOfDiffExpressedProbes", "upregulatedCount", "downregulatedCount", "qvalue", "numberOfUpregulatedProbes", "numberOfDownregulatedProbes"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DiffExResultSetSummaryValueObject:
        """Create an instance of DiffExResultSetSummaryValueObject from a JSON string"""
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic by calling `to_dict()` of baseline_group
        if self.baseline_group:
            _dict['baselineGroup'] = self.baseline_group.to_dict()
        # override the default output from pydantic by calling `to_dict()` of each item in experimental_factors (list)
        _items = []
        if self.experimental_factors:
            for _item in self.experimental_factors:
                if _item:
                    _items.append(_item.to_dict())
            _dict['experimentalFactors'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> DiffExResultSetSummaryValueObject:
        """Create an instance of DiffExResultSetSummaryValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DiffExResultSetSummaryValueObject.parse_obj(obj)

        _obj = DiffExResultSetSummaryValueObject.parse_obj({
            "id": obj.get("id"),
            "array_designs_used": obj.get("arrayDesignsUsed"),
            "baseline_group": FactorValueValueObject.from_dict(obj.get("baselineGroup")) if obj.get("baselineGroup") is not None else None,
            "experimental_factors": [ExperimentalFactorValueObject.from_dict(_item) for _item in obj.get("experimentalFactors")] if obj.get("experimentalFactors") is not None else None,
            "number_of_genes_analyzed": obj.get("numberOfGenesAnalyzed"),
            "number_of_probes_analyzed": obj.get("numberOfProbesAnalyzed"),
            "threshold": obj.get("threshold"),
            "number_of_diff_expressed_probes": obj.get("numberOfDiffExpressedProbes"),
            "upregulated_count": obj.get("upregulatedCount"),
            "downregulated_count": obj.get("downregulatedCount"),
            "qvalue": obj.get("qvalue"),
            "number_of_upregulated_probes": obj.get("numberOfUpregulatedProbes"),
            "number_of_downregulated_probes": obj.get("numberOfDownregulatedProbes")
        })
        return _obj
