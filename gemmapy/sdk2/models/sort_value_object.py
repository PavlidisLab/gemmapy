...
class SortValueObject(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SortValueObject:
        """Create an instance of SortValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SortValueObject:
        """Create an instance of SortValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SortValueObject.parse_obj(obj)

        _obj = SortValueObject.parse_obj({
