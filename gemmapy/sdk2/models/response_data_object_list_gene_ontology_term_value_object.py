...
class ResponseDataObjectListGeneOntologyTermValueObject(BaseModel):
    """
    ResponseDataObjectListGeneOntologyTermValueObject
    """
    data: Optional[conlist(GeneOntologyTermValueObject)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResponseDataObjectListGeneOntologyTermValueObject:
        """Create an instance of ResponseDataObjectListGeneOntologyTermValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResponseDataObjectListGeneOntologyTermValueObject:
        """Create an instance of ResponseDataObjectListGeneOntologyTermValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResponseDataObjectListGeneOntologyTermValueObject.parse_obj(obj)

        _obj = ResponseDataObjectListGeneOntologyTermValueObject.parse_obj({
            "data": [GeneOntologyTermValueObject.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
