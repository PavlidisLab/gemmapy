...
class DifferentialExpressionAnalysisResultValueObject(BaseModel):
    """
    DifferentialExpressionAnalysisResultValueObject
    """
    id: Optional[StrictInt] = None
    probe_id: Optional[StrictInt] = Field(None, alias="probeId")
    probe_name: Optional[StrictStr] = Field(None, alias="probeName")
    genes: Optional[conlist(GeneValueObject)] = None
    corrected_pvalue: Optional[Union[StrictFloat, StrictInt]] = Field(None, alias="correctedPvalue")
    rank: Optional[Union[StrictFloat, StrictInt]] = None
    contrasts: Optional[conlist(ContrastResultValueObject)] = None
    pvalue: Optional[Union[StrictFloat, StrictInt]] = None
    __properties = ["id", "probeId", "probeName", "genes", "correctedPvalue", "rank", "contrasts", "pvalue"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DifferentialExpressionAnalysisResultValueObject:
        """Create an instance of DifferentialExpressionAnalysisResultValueObject from a JSON string"""
    ...
    def to_dict(self):
        ...
        if self.genes:
            ...
            _dict['genes'] = _items
        # override the default output from pydantic by calling `to_dict()` of each item in contrasts (list)
        _items = []
        if self.contrasts:
            for _item in self.contrasts:
                if _item:
                    _items.append(_item.to_dict())
            _dict['contrasts'] = _items
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> DifferentialExpressionAnalysisResultValueObject:
        """Create an instance of DifferentialExpressionAnalysisResultValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DifferentialExpressionAnalysisResultValueObject.parse_obj(obj)

        _obj = DifferentialExpressionAnalysisResultValueObject.parse_obj({
            "id": obj.get("id"),
            "probe_id": obj.get("probeId"),
            "probe_name": obj.get("probeName"),
            "genes": [GeneValueObject.from_dict(_item) for _item in obj.get("genes")] if obj.get("genes") is not None else None,
            "corrected_pvalue": obj.get("correctedPvalue"),
            "rank": obj.get("rank"),
            "contrasts": [ContrastResultValueObject.from_dict(_item) for _item in obj.get("contrasts")] if obj.get("contrasts") is not None else None,
