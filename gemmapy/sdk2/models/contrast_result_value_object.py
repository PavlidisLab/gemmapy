...
class ContrastResultValueObject(BaseModel):
    """
    ContrastResultValueObject
    """
    id: Optional[StrictInt] = None
    pvalue: Optional[Union[StrictFloat, StrictInt]] = None
    coefficient: Optional[Union[StrictFloat, StrictInt]] = None
    log_fold_change: Optional[Union[StrictFloat, StrictInt]] = Field(None, alias="logFoldChange")
    factor_value: Optional[FactorValueBasicValueObject] = Field(None, alias="factorValue")
    second_factor_value: Optional[FactorValueBasicValueObject] = Field(None, alias="secondFactorValue")
    tstat: Optional[Union[StrictFloat, StrictInt]] = None
    __properties = ["id", "pvalue", "coefficient", "logFoldChange", "factorValue", "secondFactorValue", "tstat"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ContrastResultValueObject:
        """Create an instance of ContrastResultValueObject from a JSON string"""
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic by calling `to_dict()` of factor_value
        if self.factor_value:
            _dict['factorValue'] = self.factor_value.to_dict()
        # override the default output from pydantic by calling `to_dict()` of second_factor_value
        if self.second_factor_value:
            _dict['secondFactorValue'] = self.second_factor_value.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> ContrastResultValueObject:
        """Create an instance of ContrastResultValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ContrastResultValueObject.parse_obj(obj)

        _obj = ContrastResultValueObject.parse_obj({
            "id": obj.get("id"),
            "pvalue": obj.get("pvalue"),
            "coefficient": obj.get("coefficient"),
            "log_fold_change": obj.get("logFoldChange"),
            "factor_value": FactorValueBasicValueObject.from_dict(obj.get("factorValue")) if obj.get("factorValue") is not None else None,
            "second_factor_value": FactorValueBasicValueObject.from_dict(obj.get("secondFactorValue")) if obj.get("secondFactorValue") is not None else None,
            "tstat": obj.get("tstat")
        })
        return _obj
