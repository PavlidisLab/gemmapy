...
class AnnotationValueObject(BaseModel):
    """
    ...
    object_class: Optional[StrictStr] = Field(None, alias="objectClass")
    __properties = ["id", "classUri", "className", "termUri", "termName", "evidenceCode", "objectClass"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> AnnotationValueObject:
        """Create an instance of AnnotationValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> AnnotationValueObject:
        """Create an instance of AnnotationValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return AnnotationValueObject.parse_obj(obj)

        _obj = AnnotationValueObject.parse_obj({
            "id": obj.get("id"),
