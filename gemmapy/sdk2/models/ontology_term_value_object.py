...
class OntologyTermValueObject(BaseModel):
    """
    ...
    __properties = ["uri", "name", "parentTerms"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> OntologyTermValueObject:
        """Create an instance of OntologyTermValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> OntologyTermValueObject:
        """Create an instance of OntologyTermValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return OntologyTermValueObject.parse_obj(obj)

        _obj = OntologyTermValueObject.parse_obj({
            "uri": obj.get("uri"),
            "name": obj.get("name"),
...
OntologyTermValueObject.update_forward_refs()
