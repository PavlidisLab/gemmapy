...
class TaxonWithUsageStatisticsValueObject(BaseModel):
    """
    ...
    external_database: Optional[ExternalDatabaseValueObject] = Field(None, alias="externalDatabase")
    number_of_expression_experiments: Optional[StrictInt] = Field(None, alias="numberOfExpressionExperiments")
    __properties = ["id", "scientificName", "commonName", "ncbiId", "externalDatabase", "numberOfExpressionExperiments"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> TaxonWithUsageStatisticsValueObject:
        """Create an instance of TaxonWithUsageStatisticsValueObject from a JSON string"""
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic by calling `to_dict()` of external_database
        if self.external_database:
            _dict['externalDatabase'] = self.external_database.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: dict) -> TaxonWithUsageStatisticsValueObject:
        """Create an instance of TaxonWithUsageStatisticsValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return TaxonWithUsageStatisticsValueObject.parse_obj(obj)

        _obj = TaxonWithUsageStatisticsValueObject.parse_obj({
            "id": obj.get("id"),
            "scientific_name": obj.get("scientificName"),
            "common_name": obj.get("commonName"),
            "ncbi_id": obj.get("ncbiId"),
            "external_database": ExternalDatabaseValueObject.from_dict(obj.get("externalDatabase")) if obj.get("externalDatabase") is not None else None,
