...
class ResponseDataObjectListAnnotationSearchResultValueObject(BaseModel):
    """
    ResponseDataObjectListAnnotationSearchResultValueObject
    """
    data: Optional[conlist(AnnotationSearchResultValueObject)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResponseDataObjectListAnnotationSearchResultValueObject:
        """Create an instance of ResponseDataObjectListAnnotationSearchResultValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResponseDataObjectListAnnotationSearchResultValueObject:
        """Create an instance of ResponseDataObjectListAnnotationSearchResultValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResponseDataObjectListAnnotationSearchResultValueObject.parse_obj(obj)

        _obj = ResponseDataObjectListAnnotationSearchResultValueObject.parse_obj({
            "data": [AnnotationSearchResultValueObject.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
