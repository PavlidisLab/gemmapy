...
class ResponseDataObjectSimpleSVDValueObject(BaseModel):
    """
    ResponseDataObjectSimpleSVDValueObject
    """
    data: Optional[SimpleSVDValueObject] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResponseDataObjectSimpleSVDValueObject:
        """Create an instance of ResponseDataObjectSimpleSVDValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResponseDataObjectSimpleSVDValueObject:
        """Create an instance of ResponseDataObjectSimpleSVDValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResponseDataObjectSimpleSVDValueObject.parse_obj(obj)

        _obj = ResponseDataObjectSimpleSVDValueObject.parse_obj({
            "data": SimpleSVDValueObject.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
