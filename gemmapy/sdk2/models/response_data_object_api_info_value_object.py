...
class ResponseDataObjectApiInfoValueObject(BaseModel):
    """
    ResponseDataObjectApiInfoValueObject
    """
    data: Optional[ApiInfoValueObject] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResponseDataObjectApiInfoValueObject:
        """Create an instance of ResponseDataObjectApiInfoValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResponseDataObjectApiInfoValueObject:
        """Create an instance of ResponseDataObjectApiInfoValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResponseDataObjectApiInfoValueObject.parse_obj(obj)

        _obj = ResponseDataObjectApiInfoValueObject.parse_obj({
            "data": ApiInfoValueObject.from_dict(obj.get("data")) if obj.get("data") is not None else None
        })
        return _obj
