...
class ResponseDataObjectSetAnnotationValueObject(BaseModel):
    """
    ResponseDataObjectSetAnnotationValueObject
    """
    data: Optional[conlist(AnnotationValueObject, unique_items=True)] = None
    __properties = ["data"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ResponseDataObjectSetAnnotationValueObject:
        """Create an instance of ResponseDataObjectSetAnnotationValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ResponseDataObjectSetAnnotationValueObject:
        """Create an instance of ResponseDataObjectSetAnnotationValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ResponseDataObjectSetAnnotationValueObject.parse_obj(obj)

        _obj = ResponseDataObjectSetAnnotationValueObject.parse_obj({
            "data": [AnnotationValueObject.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None
        })
        return _obj
