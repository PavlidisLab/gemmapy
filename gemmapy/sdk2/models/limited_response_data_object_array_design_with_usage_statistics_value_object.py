...
class LimitedResponseDataObjectArrayDesignWithUsageStatisticsValueObject(BaseModel):
    """
    LimitedResponseDataObjectArrayDesignWithUsageStatisticsValueObject
    """
    data: Optional[conlist(ArrayDesignWithUsageStatisticsValueObject)] = None
    query: Optional[StrictStr] = None
    filter: Optional[StrictStr] = None
    group_by: Optional[conlist(StrictStr)] = Field(None, alias="groupBy")
    sort: Optional[SortValueObject] = None
    limit: Optional[StrictInt] = None
    __properties = ["data", "query", "filter", "groupBy", "sort", "limit"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> LimitedResponseDataObjectArrayDesignWithUsageStatisticsValueObject:
        """Create an instance of LimitedResponseDataObjectArrayDesignWithUsageStatisticsValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> LimitedResponseDataObjectArrayDesignWithUsageStatisticsValueObject:
        """Create an instance of LimitedResponseDataObjectArrayDesignWithUsageStatisticsValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return LimitedResponseDataObjectArrayDesignWithUsageStatisticsValueObject.parse_obj(obj)

        _obj = LimitedResponseDataObjectArrayDesignWithUsageStatisticsValueObject.parse_obj({
            "data": [ArrayDesignWithUsageStatisticsValueObject.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
            "query": obj.get("query"),
