...
class VectorElementValueObject(BaseModel):
    """
    VectorElementValueObject
    """
    design_element_name: Optional[StrictStr] = Field(None, alias="designElementName")
    bio_assay_expression_levels: Optional[Dict[str, Union[StrictFloat, StrictInt]]] = Field(None, alias="bioAssayExpressionLevels")
    __properties = ["designElementName", "bioAssayExpressionLevels"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> VectorElementValueObject:
        """Create an instance of VectorElementValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> VectorElementValueObject:
        """Create an instance of VectorElementValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return VectorElementValueObject.parse_obj(obj)

        _obj = VectorElementValueObject.parse_obj({
            "design_element_name": obj.get("designElementName"),
            "bio_assay_expression_levels": obj.get("bioAssayExpressionLevels")
        })
        return _obj
