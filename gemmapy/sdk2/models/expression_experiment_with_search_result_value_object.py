...
class ExpressionExperimentWithSearchResultValueObject(BaseModel):
    """
    ExpressionExperimentWithSearchResultValueObject
    """
    id: Optional[StrictInt] = None
    last_updated: Optional[datetime] = Field(None, alias="lastUpdated")
    troubled: Optional[StrictBool] = None
    last_troubled_event: Optional[AuditEventValueObject] = Field(None, alias="lastTroubledEvent")
    needs_attention: Optional[StrictBool] = Field(None, alias="needsAttention")
    last_needs_attention_event: Optional[AuditEventValueObject] = Field(None, alias="lastNeedsAttentionEvent")
    curation_note: Optional[StrictStr] = Field(None, alias="curationNote")
    last_note_update_event: Optional[AuditEventValueObject] = Field(None, alias="lastNoteUpdateEvent")
    number_of_bio_assays: Optional[StrictInt] = Field(None, alias="numberOfBioAssays")
    description: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    accession: Optional[StrictStr] = None
    batch_confound: Optional[StrictStr] = Field(None, alias="batchConfound")
    batch_effect: Optional[StrictStr] = Field(None, alias="batchEffect")
    external_database: Optional[StrictStr] = Field(None, alias="externalDatabase")
    external_uri: Optional[StrictStr] = Field(None, alias="externalUri")
    geeq: Optional[GeeqValueObject] = None
    metadata: Optional[StrictStr] = None
    short_name: Optional[StrictStr] = Field(None, alias="shortName")
    source: Optional[StrictStr] = None
    technology_type: Optional[StrictStr] = Field(None, alias="technologyType")
    search_result: Optional[SearchResultValueObjectExpressionExperimentValueObject] = Field(None, alias="searchResult")
    taxon_id: Optional[StrictInt] = Field(None, alias="taxonId")
    bio_assay_count: Optional[StrictInt] = Field(None, alias="bioAssayCount")
    trouble_details: Optional[StrictStr] = Field(None, alias="troubleDetails")
    number_of_array_designs: Optional[StrictInt] = Field(None, alias="numberOfArrayDesigns")
    number_of_processed_expression_vectors: Optional[StrictInt] = Field(None, alias="numberOfProcessedExpressionVectors")
    taxon: Optional[TaxonValueObject] = None
    __properties = ["id", "lastUpdated", "troubled", "lastTroubledEvent", "needsAttention", "lastNeedsAttentionEvent", "curationNote", "lastNoteUpdateEvent", "numberOfBioAssays", "description", "name", "accession", "batchConfound", "batchEffect", "externalDatabase", "externalUri", "geeq", "metadata", "shortName", "source", "technologyType", "searchResult", "taxonId", "bioAssayCount", "troubleDetails", "numberOfArrayDesigns", "numberOfProcessedExpressionVectors", "taxon"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ExpressionExperimentWithSearchResultValueObject:
        """Create an instance of ExpressionExperimentWithSearchResultValueObject from a JSON string"""
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic by calling `to_dict()` of last_troubled_event
        if self.last_troubled_event:
            _dict['lastTroubledEvent'] = self.last_troubled_event.to_dict()
        # override the default output from pydantic by calling `to_dict()` of last_needs_attention_event
        if self.last_needs_attention_event:
            _dict['lastNeedsAttentionEvent'] = self.last_needs_attention_event.to_dict()
        # override the default output from pydantic by calling `to_dict()` of last_note_update_event
        if self.last_note_update_event:
            _dict['lastNoteUpdateEvent'] = self.last_note_update_event.to_dict()
        # override the default output from pydantic by calling `to_dict()` of geeq
        if self.geeq:
            _dict['geeq'] = self.geeq.to_dict()
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ExpressionExperimentWithSearchResultValueObject:
        """Create an instance of ExpressionExperimentWithSearchResultValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ExpressionExperimentWithSearchResultValueObject.parse_obj(obj)

        _obj = ExpressionExperimentWithSearchResultValueObject.parse_obj({
            "id": obj.get("id"),
            "last_updated": obj.get("lastUpdated"),
            "troubled": obj.get("troubled"),
            "last_troubled_event": AuditEventValueObject.from_dict(obj.get("lastTroubledEvent")) if obj.get("lastTroubledEvent") is not None else None,
            "needs_attention": obj.get("needsAttention"),
            "last_needs_attention_event": AuditEventValueObject.from_dict(obj.get("lastNeedsAttentionEvent")) if obj.get("lastNeedsAttentionEvent") is not None else None,
            "curation_note": obj.get("curationNote"),
            "last_note_update_event": AuditEventValueObject.from_dict(obj.get("lastNoteUpdateEvent")) if obj.get("lastNoteUpdateEvent") is not None else None,
            "number_of_bio_assays": obj.get("numberOfBioAssays"),
            "description": obj.get("description"),
            "name": obj.get("name"),
            "accession": obj.get("accession"),
            "batch_confound": obj.get("batchConfound"),
            "batch_effect": obj.get("batchEffect"),
            "external_database": obj.get("externalDatabase"),
            "external_uri": obj.get("externalUri"),
            "geeq": GeeqValueObject.from_dict(obj.get("geeq")) if obj.get("geeq") is not None else None,
            "metadata": obj.get("metadata"),
            "short_name": obj.get("shortName"),
            "source": obj.get("source"),
            "technology_type": obj.get("technologyType"),
            "search_result": SearchResultValueObjectExpressionExperimentValueObject.from_dict(obj.get("searchResult")) if obj.get("searchResult") is not None else None,
            "taxon_id": obj.get("taxonId"),
            "bio_assay_count": obj.get("bioAssayCount"),
            "trouble_details": obj.get("troubleDetails"),
            "number_of_array_designs": obj.get("numberOfArrayDesigns"),
            "number_of_processed_expression_vectors": obj.get("numberOfProcessedExpressionVectors"),
            "taxon": TaxonValueObject.from_dict(obj.get("taxon")) if obj.get("taxon") is not None else None
        })
        return _obj
