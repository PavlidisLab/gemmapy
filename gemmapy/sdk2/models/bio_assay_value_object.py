...
class BioAssayValueObject(BaseModel):
    """
    BioAssayValueObject
    """
    id: Optional[StrictInt] = None
    accession: Optional[DatabaseEntryValueObject] = None
    array_design: Optional[ArrayDesignValueObject] = Field(None, alias="arrayDesign")
    description: Optional[StrictStr] = None
    metadata: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    original_platform: Optional[ArrayDesignValueObject] = Field(None, alias="originalPlatform")
    outlier: Optional[StrictBool] = None
    predicted_outlier: Optional[StrictBool] = Field(None, alias="predictedOutlier")
    processing_date: Optional[datetime] = Field(None, alias="processingDate")
    sample: Optional[BioMaterialValueObject] = None
    sequence_paired_reads: Optional[StrictBool] = Field(None, alias="sequencePairedReads")
    sequence_read_count: Optional[StrictInt] = Field(None, alias="sequenceReadCount")
    sequence_read_length: Optional[StrictInt] = Field(None, alias="sequenceReadLength")
    user_flagged_outlier: Optional[StrictBool] = Field(None, alias="userFlaggedOutlier")
    __properties = ["id", "accession", "arrayDesign", "description", "metadata", "name", "originalPlatform", "outlier", "predictedOutlier", "processingDate", "sample", "sequencePairedReads", "sequenceReadCount", "sequenceReadLength", "userFlaggedOutlier"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BioAssayValueObject:
        """Create an instance of BioAssayValueObject from a JSON string"""
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic by calling `to_dict()` of accession
        if self.accession:
            _dict['accession'] = self.accession.to_dict()
        # override the default output from pydantic by calling `to_dict()` of array_design
        if self.array_design:
            _dict['arrayDesign'] = self.array_design.to_dict()
        # override the default output from pydantic by calling `to_dict()` of original_platform
        if self.original_platform:
            _dict['originalPlatform'] = self.original_platform.to_dict()
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BioAssayValueObject:
        """Create an instance of BioAssayValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BioAssayValueObject.parse_obj(obj)

        _obj = BioAssayValueObject.parse_obj({
            "id": obj.get("id"),
            "accession": DatabaseEntryValueObject.from_dict(obj.get("accession")) if obj.get("accession") is not None else None,
            "array_design": ArrayDesignValueObject.from_dict(obj.get("arrayDesign")) if obj.get("arrayDesign") is not None else None,
            "description": obj.get("description"),
            "metadata": obj.get("metadata"),
            "name": obj.get("name"),
            "original_platform": ArrayDesignValueObject.from_dict(obj.get("originalPlatform")) if obj.get("originalPlatform") is not None else None,
            "outlier": obj.get("outlier"),
            "predicted_outlier": obj.get("predictedOutlier"),
            "processing_date": obj.get("processingDate"),
            "sample": BioMaterialValueObject.from_dict(obj.get("sample")) if obj.get("sample") is not None else None,
            "sequence_paired_reads": obj.get("sequencePairedReads"),
            "sequence_read_count": obj.get("sequenceReadCount"),
            "sequence_read_length": obj.get("sequenceReadLength"),
            "user_flagged_outlier": obj.get("userFlaggedOutlier")
        })
        return _obj
