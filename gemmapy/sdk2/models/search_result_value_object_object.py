...
class SearchResultValueObjectObject(BaseModel):
    """
    ...
    result_object: Optional[SearchResultValueObjectObjectResultObject] = Field(None, alias="resultObject")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> SearchResultValueObjectObject:
        """Create an instance of SearchResultValueObjectObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> SearchResultValueObjectObject:
        """Create an instance of SearchResultValueObjectObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return SearchResultValueObjectObject.parse_obj(obj)

        _obj = SearchResultValueObjectObject.parse_obj({
            "result_id": obj.get("resultId"),
            "result_type": obj.get("resultType"),
            "score": obj.get("score"),
            "highlights": obj.get("highlights"),
            "result_object": SearchResultValueObjectObjectResultObject.from_dict(obj.get("resultObject")) if obj.get("resultObject") is not None else None
        })
        return _obj
