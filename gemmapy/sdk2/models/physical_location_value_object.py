...
class PhysicalLocationValueObject(BaseModel):
    """
    PhysicalLocationValueObject
    """
    id: Optional[StrictInt] = None
    nucleotide: Optional[StrictInt] = None
    nucleotide_length: Optional[StrictInt] = Field(None, alias="nucleotideLength")
    ...
    __properties = ["id", "nucleotide", "nucleotideLength", "strand", "bin", "chromosome", "taxon"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> PhysicalLocationValueObject:
        """Create an instance of PhysicalLocationValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> PhysicalLocationValueObject:
        """Create an instance of PhysicalLocationValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return PhysicalLocationValueObject.parse_obj(obj)

        _obj = PhysicalLocationValueObject.parse_obj({
            "id": obj.get("id"),
            "nucleotide": obj.get("nucleotide"),
            "nucleotide_length": obj.get("nucleotideLength"),
