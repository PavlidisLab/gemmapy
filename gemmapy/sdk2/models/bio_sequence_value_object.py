...
class BioSequenceValueObject(BaseModel):
    """
    BioSequenceValueObject
    """
    id: Optional[StrictInt] = None
    description: Optional[StrictStr] = None
    fraction_repeats: Optional[Union[StrictFloat, StrictInt]] = Field(None, alias="fractionRepeats")
    length: Optional[StrictInt] = None
    name: Optional[StrictStr] = None
    sequence: Optional[StrictStr] = None
    sequence_database_entry: Optional[DatabaseEntryValueObject] = Field(None, alias="sequenceDatabaseEntry")
    taxon: Optional[TaxonValueObject] = None
    type: Optional[StrictStr] = None
    __properties = ["id", "description", "fractionRepeats", "length", "name", "sequence", "sequenceDatabaseEntry", "taxon", "type"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BioSequenceValueObject:
        """Create an instance of BioSequenceValueObject from a JSON string"""
    ...
    def to_dict(self):
        ...
        _dict = self.dict(by_alias=True,
                          ...
                          exclude_none=True)
        # override the default output from pydantic by calling `to_dict()` of sequence_database_entry
        if self.sequence_database_entry:
            _dict['sequenceDatabaseEntry'] = self.sequence_database_entry.to_dict()
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BioSequenceValueObject:
        """Create an instance of BioSequenceValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BioSequenceValueObject.parse_obj(obj)

        _obj = BioSequenceValueObject.parse_obj({
            "id": obj.get("id"),
            "description": obj.get("description"),
            "fraction_repeats": obj.get("fractionRepeats"),
            "length": obj.get("length"),
            "name": obj.get("name"),
            "sequence": obj.get("sequence"),
            "sequence_database_entry": DatabaseEntryValueObject.from_dict(obj.get("sequenceDatabaseEntry")) if obj.get("sequenceDatabaseEntry") is not None else None,
