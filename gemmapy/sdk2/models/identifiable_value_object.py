...
class IdentifiableValueObject(BaseModel):
    """
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IdentifiableValueObject:
        """Create an instance of IdentifiableValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IdentifiableValueObject:
        """Create an instance of IdentifiableValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IdentifiableValueObject.parse_obj(obj)

        _obj = IdentifiableValueObject.parse_obj({
            "id": obj.get("id")
        })
        return _obj
