...
class CategoryWithUsageStatisticsValueObject(BaseModel):
    """
    ...
    __properties = ["classUri", "className", "numberOfExpressionExperiments"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> CategoryWithUsageStatisticsValueObject:
        """Create an instance of CategoryWithUsageStatisticsValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> CategoryWithUsageStatisticsValueObject:
        """Create an instance of CategoryWithUsageStatisticsValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return CategoryWithUsageStatisticsValueObject.parse_obj(obj)

        _obj = CategoryWithUsageStatisticsValueObject.parse_obj({
