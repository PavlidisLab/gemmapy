...
class QuantitationTypeValueObject(BaseModel):
    """
    QuantitationTypeValueObject
    """
    id: Optional[StrictInt] = None
    description: Optional[StrictStr] = None
    general_type: Optional[StrictStr] = Field(None, alias="generalType")
    is_background: Optional[StrictBool] = Field(None, alias="isBackground")
    is_background_subtracted: Optional[StrictBool] = Field(None, alias="isBackgroundSubtracted")
    is_batch_corrected: Optional[StrictBool] = Field(None, alias="isBatchCorrected")
    is_masked_preferred: Optional[StrictBool] = Field(None, alias="isMaskedPreferred")
    is_normalized: Optional[StrictBool] = Field(None, alias="isNormalized")
    is_preferred: Optional[StrictBool] = Field(None, alias="isPreferred")
    is_ratio: Optional[StrictBool] = Field(None, alias="isRatio")
    is_recomputed_from_raw_data: Optional[StrictBool] = Field(None, alias="isRecomputedFromRawData")
    name: Optional[StrictStr] = None
    representation: Optional[StrictStr] = None
    scale: Optional[StrictStr] = None
    type: Optional[StrictStr] = None
    vector_type: Optional[StrictStr] = Field(None, alias="vectorType")
    __properties = ["id", "description", "generalType", "isBackground", "isBackgroundSubtracted", "isBatchCorrected", "isMaskedPreferred", "isNormalized", "isPreferred", "isRatio", "isRecomputedFromRawData", "name", "representation", "scale", "type", "vectorType"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> QuantitationTypeValueObject:
        """Create an instance of QuantitationTypeValueObject from a JSON string"""
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> QuantitationTypeValueObject:
        """Create an instance of QuantitationTypeValueObject from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return QuantitationTypeValueObject.parse_obj(obj)

        _obj = QuantitationTypeValueObject.parse_obj({
            "id": obj.get("id"),
            "description": obj.get("description"),
            "general_type": obj.get("generalType"),
            "is_background": obj.get("isBackground"),
            "is_background_subtracted": obj.get("isBackgroundSubtracted"),
            "is_batch_corrected": obj.get("isBatchCorrected"),
            "is_masked_preferred": obj.get("isMaskedPreferred"),
            "is_normalized": obj.get("isNormalized"),
            "is_preferred": obj.get("isPreferred"),
            "is_ratio": obj.get("isRatio"),
            "is_recomputed_from_raw_data": obj.get("isRecomputedFromRawData"),
            "name": obj.get("name"),
            "representation": obj.get("representation"),
            "scale": obj.get("scale"),
            "type": obj.get("type"),
            "vector_type": obj.get("vectorType")
        })
        return _obj
