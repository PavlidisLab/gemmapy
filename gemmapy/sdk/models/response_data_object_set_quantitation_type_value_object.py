...
class ResponseDataObjectSetQuantitationTypeValueObject(object):
    ...
    """
    swagger_types = {
        'data': 'list[QuantitationTypeValueObject]'
    }
    ...
    def __init__(self, data=None):  # noqa: E501
        """ResponseDataObjectSetQuantitationTypeValueObject - a model defined in Swagger"""  # noqa: E501
        self._data = None
    ...
    def data(self):
        ...
        :return: The data of this ResponseDataObjectSetQuantitationTypeValueObject.  # noqa: E501
        :rtype: list[QuantitationTypeValueObject]
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this ResponseDataObjectSetQuantitationTypeValueObject.


        :param data: The data of this ResponseDataObjectSetQuantitationTypeValueObject.  # noqa: E501
        :type: list[QuantitationTypeValueObject]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ResponseDataObjectSetQuantitationTypeValueObject, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResponseDataObjectSetQuantitationTypeValueObject):
            return False
