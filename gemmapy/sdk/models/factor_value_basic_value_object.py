...
class FactorValueBasicValueObject(object):
    ...
    def __init__(self, id=None, experimental_factor_id=None, experimental_factor_category=None, measurement=None, characteristics=None, value=None, summary=None):  # noqa: E501
