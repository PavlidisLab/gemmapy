...
class ResponseDataObjectListExperimentExpressionLevelsValueObject(object):
    ...
    """
    swagger_types = {
        'data': 'list[ExperimentExpressionLevelsValueObject]'
    }
    ...
    def __init__(self, data=None):  # noqa: E501
        """ResponseDataObjectListExperimentExpressionLevelsValueObject - a model defined in Swagger"""  # noqa: E501
        self._data = None
    ...
    def data(self):
        ...
        :return: The data of this ResponseDataObjectListExperimentExpressionLevelsValueObject.  # noqa: E501
        :rtype: list[ExperimentExpressionLevelsValueObject]
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this ResponseDataObjectListExperimentExpressionLevelsValueObject.


        :param data: The data of this ResponseDataObjectListExperimentExpressionLevelsValueObject.  # noqa: E501
        :type: list[ExperimentExpressionLevelsValueObject]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ResponseDataObjectListExperimentExpressionLevelsValueObject, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResponseDataObjectListExperimentExpressionLevelsValueObject):
            return False
