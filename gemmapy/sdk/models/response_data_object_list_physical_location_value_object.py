...
class ResponseDataObjectListPhysicalLocationValueObject(object):
    ...
    """
    swagger_types = {
        'data': 'list[PhysicalLocationValueObject]'
    }
    ...
    def __init__(self, data=None):  # noqa: E501
        """ResponseDataObjectListPhysicalLocationValueObject - a model defined in Swagger"""  # noqa: E501
        self._data = None
    ...
    def data(self):
        ...
        :return: The data of this ResponseDataObjectListPhysicalLocationValueObject.  # noqa: E501
        :rtype: list[PhysicalLocationValueObject]
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this ResponseDataObjectListPhysicalLocationValueObject.


        :param data: The data of this ResponseDataObjectListPhysicalLocationValueObject.  # noqa: E501
        :type: list[PhysicalLocationValueObject]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ResponseDataObjectListPhysicalLocationValueObject, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResponseDataObjectListPhysicalLocationValueObject):
            return False
