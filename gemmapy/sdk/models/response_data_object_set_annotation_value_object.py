...
class ResponseDataObjectSetAnnotationValueObject(object):
    ...
    """
    swagger_types = {
        'data': 'list[AnnotationValueObject]'
    }
    ...
    def __init__(self, data=None):  # noqa: E501
        """ResponseDataObjectSetAnnotationValueObject - a model defined in Swagger"""  # noqa: E501
        self._data = None
    ...
    def data(self):
        ...
        :return: The data of this ResponseDataObjectSetAnnotationValueObject.  # noqa: E501
        :rtype: list[AnnotationValueObject]
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this ResponseDataObjectSetAnnotationValueObject.


        :param data: The data of this ResponseDataObjectSetAnnotationValueObject.  # noqa: E501
        :type: list[AnnotationValueObject]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ResponseDataObjectSetAnnotationValueObject, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResponseDataObjectSetAnnotationValueObject):
            return False
