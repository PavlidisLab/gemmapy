...
class ResponseDataObjectLong(object):
    ...
    def __init__(self, data=None):  # noqa: E501
        """ResponseDataObjectLong - a model defined in Swagger"""  # noqa: E501
        self._data = None
    ...
    def data(self):
        ...
        :return: The data of this ResponseDataObjectLong.  # noqa: E501
        :rtype: int
        """
        return self._data
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this ResponseDataObjectLong.


        :param data: The data of this ResponseDataObjectLong.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ResponseDataObjectLong, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResponseDataObjectLong):
            return False
