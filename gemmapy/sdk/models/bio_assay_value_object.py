...
class BioAssayValueObject(object):
    ...
    def __init__(self, id=None, short_name=None, name=None, description=None, metadata=None, accession=None, array_design=None, original_platform=None, processing_date=None, sample=None, sequence_paired_reads=None, sequence_read_count=None, sequence_read_length=None, outlier=None, predicted_outlier=None, user_flagged_outlier=None, source_bio_assay_id=None):  # noqa: E501
