...
class BioAssayValueObject(object):
    ...
    swagger_types = {
        ...
        'number_of_cells': 'int',
        'number_of_design_elements': 'int',
        'number_of_cells_by_design_elements': 'int',
        'outlier': 'bool',
        'predicted_outlier': 'bool',
        'user_flagged_outlier': 'bool',
        'source_bio_assay_id': 'int'
    }
    ...
    attribute_map = {
        ...
        'number_of_design_elements': 'numberOfDesignElements',
        'number_of_cells_by_design_elements': 'numberOfCellsByDesignElements',
        'outlier': 'outlier',
        'predicted_outlier': 'predictedOutlier',
        'user_flagged_outlier': 'userFlaggedOutlier',
        'source_bio_assay_id': 'sourceBioAssayId'
    }

    def __init__(self, id=None, short_name=None, name=None, description=None, metadata=None, accession=None, array_design=None, original_platform=None, processing_date=None, sample=None, sequence_paired_reads=None, sequence_read_count=None, sequence_read_length=None, number_of_cells=None, number_of_design_elements=None, number_of_cells_by_design_elements=None, outlier=None, predicted_outlier=None, user_flagged_outlier=None, source_bio_assay_id=None):  # noqa: E501
        ...
        self._number_of_design_elements = None
        self._number_of_cells_by_design_elements = None
        self._outlier = None
        self._predicted_outlier = None
        self._user_flagged_outlier = None
        self._source_bio_assay_id = None
        ...
        if number_of_design_elements is not None:
            self.number_of_design_elements = number_of_design_elements
        if number_of_cells_by_design_elements is not None:
            self.number_of_cells_by_design_elements = number_of_cells_by_design_elements
        ...
        if source_bio_assay_id is not None:
            self.source_bio_assay_id = source_bio_assay_id
    ...
    @property
    def short_name(self):
        """Gets the short_name of this BioAssayValueObject.  # noqa: E501


        :return: The short_name of this BioAssayValueObject.  # noqa: E501
        :rtype: str
        """
    ...
    def short_name(self, short_name):
        """Sets the short_name of this BioAssayValueObject.


        :param short_name: The short_name of this BioAssayValueObject.  # noqa: E501
        :type: str
        """
    ...
    def number_of_cells(self):
        """Gets the number_of_cells of this BioAssayValueObject.  # noqa: E501


        :return: The number_of_cells of this BioAssayValueObject.  # noqa: E501
        :rtype: int
        """
    ...
    def number_of_cells(self, number_of_cells):
        """Sets the number_of_cells of this BioAssayValueObject.


        :param number_of_cells: The number_of_cells of this BioAssayValueObject.  # noqa: E501
        :type: int
        """
    ...
    @property
    def number_of_design_elements(self):
        """Gets the number_of_design_elements of this BioAssayValueObject.  # noqa: E501


        :return: The number_of_design_elements of this BioAssayValueObject.  # noqa: E501
        :rtype: int
        """
        return self._number_of_design_elements

    @number_of_design_elements.setter
    def number_of_design_elements(self, number_of_design_elements):
        """Sets the number_of_design_elements of this BioAssayValueObject.


        :param number_of_design_elements: The number_of_design_elements of this BioAssayValueObject.  # noqa: E501
        :type: int
        """

        self._number_of_design_elements = number_of_design_elements

    @property
    def number_of_cells_by_design_elements(self):
        """Gets the number_of_cells_by_design_elements of this BioAssayValueObject.  # noqa: E501


        :return: The number_of_cells_by_design_elements of this BioAssayValueObject.  # noqa: E501
        :rtype: int
        """
        return self._number_of_cells_by_design_elements

    @number_of_cells_by_design_elements.setter
    def number_of_cells_by_design_elements(self, number_of_cells_by_design_elements):
        """Sets the number_of_cells_by_design_elements of this BioAssayValueObject.


        :param number_of_cells_by_design_elements: The number_of_cells_by_design_elements of this BioAssayValueObject.  # noqa: E501
        :type: int
        """

        self._number_of_cells_by_design_elements = number_of_cells_by_design_elements
    ...
    @property
    def source_bio_assay_id(self):
        """Gets the source_bio_assay_id of this BioAssayValueObject.  # noqa: E501


        :return: The source_bio_assay_id of this BioAssayValueObject.  # noqa: E501
        :rtype: int
        """
        return self._source_bio_assay_id

    @source_bio_assay_id.setter
    def source_bio_assay_id(self, source_bio_assay_id):
        """Sets the source_bio_assay_id of this BioAssayValueObject.


        :param source_bio_assay_id: The source_bio_assay_id of this BioAssayValueObject.  # noqa: E501
        :type: int
        """

        self._source_bio_assay_id = source_bio_assay_id
