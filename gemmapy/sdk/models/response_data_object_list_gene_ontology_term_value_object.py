...
class ResponseDataObjectListGeneOntologyTermValueObject(object):
    ...
    """
    swagger_types = {
        'data': 'list[GeneOntologyTermValueObject]'
    }
    ...
    def __init__(self, data=None):  # noqa: E501
        """ResponseDataObjectListGeneOntologyTermValueObject - a model defined in Swagger"""  # noqa: E501
        self._data = None
    ...
    def data(self):
        ...
        :return: The data of this ResponseDataObjectListGeneOntologyTermValueObject.  # noqa: E501
        :rtype: list[GeneOntologyTermValueObject]
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this ResponseDataObjectListGeneOntologyTermValueObject.


        :param data: The data of this ResponseDataObjectListGeneOntologyTermValueObject.  # noqa: E501
        :type: list[GeneOntologyTermValueObject]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ResponseDataObjectListGeneOntologyTermValueObject, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResponseDataObjectListGeneOntologyTermValueObject):
            return False
