...
class DifferentialExpressionAnalysisValueObject(object):
    ...
    def __init__(self, id=None, name=None, protocol=None, factor_values_used=None, result_sets=None, array_designs_used=None, experiment_analyzed_id=None, source_experiment_id=None, subset_factor=None, subset_factor_id=None, subset_factor_value=None, subset_factor_value_id=None, bio_assay_set_id=None, source_experiment=None, factor_values_used_by_experimental_factor_id=None, is_subset=None):  # noqa: E501
