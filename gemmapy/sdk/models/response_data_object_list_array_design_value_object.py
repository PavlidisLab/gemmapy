...
class ResponseDataObjectListArrayDesignValueObject(object):
    ...
    def __init__(self, data=None):  # noqa: E501
        """ResponseDataObjectListArrayDesignValueObject - a model defined in Swagger"""  # noqa: E501
        self._data = None
    ...
    def data(self):
        ...
        :return: The data of this ResponseDataObjectListArrayDesignValueObject.  # noqa: E501
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this ResponseDataObjectListArrayDesignValueObject.


        :param data: The data of this ResponseDataObjectListArrayDesignValueObject.  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ResponseDataObjectListArrayDesignValueObject, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResponseDataObjectListArrayDesignValueObject):
            return False
