...
class GeneValueObject(object):
    ...
    def __init__(self, id=None, aliases=None, associated_experiment_count=None, multifunctionality_rank=None, ncbi_id=None, ensembl_id=None, accessions=None, official_name=None, official_symbol=None, ncbi_uri=None, taxon=None, taxon_id=None):  # noqa: E501
        ...
        if ncbi_uri is not None:
            self.ncbi_uri = ncbi_uri
    ...
    @property
    def ncbi_uri(self):
        """Gets the ncbi_uri of this GeneValueObject.  # noqa: E501

        Synthetic ontology-style URI for this gene, derived from its NCBI gene ID. Null when no NCBI ID is available.  # noqa: E501

        :return: The ncbi_uri of this GeneValueObject.  # noqa: E501
        :rtype: str
        """
        return self._ncbi_uri

    @ncbi_uri.setter
    def ncbi_uri(self, ncbi_uri):
        """Sets the ncbi_uri of this GeneValueObject.

        Synthetic ontology-style URI for this gene, derived from its NCBI gene ID. Null when no NCBI ID is available.  # noqa: E501

        :param ncbi_uri: The ncbi_uri of this GeneValueObject.  # noqa: E501
        :type: str
        """

        self._ncbi_uri = ncbi_uri
