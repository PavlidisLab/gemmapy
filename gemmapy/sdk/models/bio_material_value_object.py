...
class BioMaterialValueObject(object):
    ...
    def __init__(self, id=None, name=None, description=None, bio_assay_ids=None, characteristics=None, source_bio_material_id=None, factors=None, factor_value_objects=None, factor_values=None):  # noqa: E501
