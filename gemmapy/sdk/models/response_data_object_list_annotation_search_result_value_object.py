...
class ResponseDataObjectListAnnotationSearchResultValueObject(object):
    ...
    """
    swagger_types = {
        'data': 'list[AnnotationSearchResultValueObject]'
    }
    ...
    def __init__(self, data=None):  # noqa: E501
        """ResponseDataObjectListAnnotationSearchResultValueObject - a model defined in Swagger"""  # noqa: E501
        self._data = None
    ...
    def data(self):
        ...
        :return: The data of this ResponseDataObjectListAnnotationSearchResultValueObject.  # noqa: E501
        :rtype: list[AnnotationSearchResultValueObject]
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this ResponseDataObjectListAnnotationSearchResultValueObject.


        :param data: The data of this ResponseDataObjectListAnnotationSearchResultValueObject.  # noqa: E501
        :type: list[AnnotationSearchResultValueObject]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ResponseDataObjectListAnnotationSearchResultValueObject, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ResponseDataObjectListAnnotationSearchResultValueObject):
            return False
