...
class FactorValueValueObject(object):
    ...
    def __init__(self, id=None, category=None, category_uri=None, description=None, factor_value=None, value=None, value_uri=None, char_id=None, factor_id=None, characteristics=None, measurement=None, is_measurement=None):  # noqa: E501
